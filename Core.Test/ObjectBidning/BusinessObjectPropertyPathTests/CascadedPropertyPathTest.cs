...
namespace Rubicon.Core.UnitTests.ObjectBidning.BusinessObjectPropertyPathTests
{
  ...
  public class CascadedPropertyPathTest
  {
    ...
    [Test]
    [ExpectedException (typeof (InvalidOperationException), "A null value was detected in element 0 of property path ReferenceProperty.Property. Cannot evaluate rest of path.")]
