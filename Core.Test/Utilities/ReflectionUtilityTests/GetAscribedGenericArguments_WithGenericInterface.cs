...
namespace Rubicon.Core.UnitTests.Utilities.ReflectionUtilityTests
{
  ...
  public class GetAscribedGenericArguments_WithGenericInterface
  {
    ...
    [Test]
    [ExpectedException (typeof (AmbiguousMatchException), ExpectedMessage = "The type Rubicon.Core.UnitTests.Utilities.ReflectionUtilityTests."
        + "IDoubleInheritingGenericInterface implements the given interface type Rubicon.Core.UnitTests.Utilities.ReflectionUtilityTests."
