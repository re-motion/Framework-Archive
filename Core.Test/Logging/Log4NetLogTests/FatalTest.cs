...
namespace Rubicon.Core.UnitTests.Logging.Log4NetLogTests
{
  ...
  public class FatalTest
  {
    ...
    {
      _logger.Repository.Threshold = Level.Fatal;
      _logger.Log (GetType (), Level.Fatal, "The message.", null);
    ...
    public void Test_WithMessageEventIDAndException ()
    {
      ...
      _log.Fatal (1, (object) "The message.", exception);
    ...
    public void Test_WithMessageAndEventID ()
    {
      ...
      _log.Fatal (1, (object) "The message.");
    ...
    public void Test_FormatWithMessageAndEventIDAndException ()
    {
      ...
      _log.FatalFormat (1, exception, "{0} {1}", "The", "message.");
    ...
    public void Test_FormatWithMessageAndEventID ()
    {
      ...
      _log.FatalFormat (1, "{0} {1}", "The", "message.");
