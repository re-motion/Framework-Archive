...
namespace Remotion.Diagnostics.ToText.Internal.ToTextProviderHandler
{
  ...
  /// </summary>
  public class ToTextProviderRegisteredInterfaceHandlerHandler : Internal.ToTextProviderHandler.ToTextProviderHandler
  {
    ...
    {
      Internal.ToTextProviderHandler.ToTextProviderHandler.CheckNotNull (toTextParameters, toTextProviderHandlerFeedback);
