...
namespace Remotion.UnitTests.Diagnostics
{
  internal class Class1
  {
    ...
    public Class1 (string name, int i)
    {
      Name = name;
      Int = i;
    }
  ...
  [TestFixture]
  public class NoNUntiTestsFound
  {
    ...
    public void ToTextXmlInstanceTest ()
    {
      ...
      //toTextProvider.RegisterSpecificTypeHandler<Class1>((t,tb) => tb.sbLiteral ("[", ",", "]").e ("TestSimple").e (t.Name).e (t.Int).se ());
      toTextProvider.RegisterSpecificTypeHandler<Class1> ((t, tb) => tb.sb ().e ("This is a sample specifc type handler - important members listed first:").e (() => t.Int).e (() => t.Name).se ());

      //var simpleTest = new ToTextProviderTest.TestSimple ();
      var simpleTest = new Class1 ("ToTextXmlInstanceTest", 333);
      var aNumber = 123.456;
    ...
    public void ToTextXmlLoopTest2 ()
    {
      ...
      toTextProvider.Settings.UseAutomaticObjectToText = true;
      //toTextProvider.RegisterSpecificTypeHandler<Class1>((t,tb) => tb.sbLiteral ("[", ",", "]").e ("TestSimple").e (t.Name).e (t.Int).se ());
      toTextProvider.RegisterSpecificTypeHandler<Class1> ((t, tb) => tb.sb ().e ("This is a sample specifc type handler - important members listed first:").e (() => t.Int).e (() => t.Name).e (() => t.Talk).se ());

      //var simpleTest = new ToTextProviderTest.TestSimple ();
      var simpleTest = new Class1 ("ToTextXmlInstanceTest", 333);
      simpleTest.Talk = new Class2 ("Silverlight");
