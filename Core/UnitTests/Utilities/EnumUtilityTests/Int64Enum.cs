...
namespace Remotion.UnitTests.Utilities.EnumUtilityTests
{
  ...
  public class Int64Enum
  {
    ...
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue ((TestEnum) (-3L)));
    }
    ...
    [Test]
    public void IsValidEnumValue_WithTypeAndInt64 ()
    {
      Assert.IsTrue (EnumUtility.IsValidEnumValue (typeof (TestEnum),( Int64) 1));
    }
    ...
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue ((TestFlags) (-3L)));
    }

    [Test]
    public void IsValidEnumValue_WithFlag_AndValueOutOfRange_UndefinedBit ()
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue (TestFlags.Flag1 | ((TestFlags) 16L)));
    }
