...
namespace Remotion.UnitTests.Utilities.EnumUtilityTests
{
  ...
  public class SByteEnum
  {
    ...
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue ((TestEnum) (sbyte)(-3)));
    }
    ...
    [Test]
    public void IsValidEnumValue_WithTypeAndSByte ()
    {
      Assert.IsTrue (EnumUtility.IsValidEnumValue (typeof (TestEnum), (SByte)1));
    }
    ...
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue ((TestFlags) (sbyte) (-3)));
    }

    [Test]
    public void IsValidEnumValue_WithFlag_AndValueOutOfRange_UndefinedBit ()
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue (TestFlags.Flag1 | ((TestFlags) (sbyte) 16)));
    }
