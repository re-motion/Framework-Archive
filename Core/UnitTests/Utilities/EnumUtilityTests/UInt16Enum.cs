...
namespace Remotion.UnitTests.Utilities.EnumUtilityTests
{
  ...
  public class UInt16Enum
  {
    ...
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue ((TestEnum) (ushort) Convert.ToInt16 ((short)(-3))));
    }

    [Test]
    public void IsValidEnumValue_WithEnum_AndValueOutOfRange_Positive ()
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue ((TestEnum) (ushort)3));
    }
    ...
    {
      Assert.IsFalse (EnumUtility.IsValidEnumValue (TestFlags.Flag1 | ((TestFlags) (ushort)16)));
    }

    [Test]
    public void IsValidEnumValue_WithTypeAndUInt16 ()
    {
      Assert.IsTrue (EnumUtility.IsValidEnumValue (typeof (TestEnum), (UInt16)1));
    }
