...
public struct NaInt64: INaNullable, IComparable, IFormattable, IXmlSerializable//, ISerializable
{
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="NaInt64"/> structure using the supplied integer value.
  /// </summary>
  /// <param name="value">The integer to be converted.</param>
  public NaInt64 (Int64 value)
  {
    _value = value;
    _isNotNull = true;
  }

  private NaInt64 (bool isNull)
  {
    _value = 0;
    _isNotNull = ! isNull;
  }
...
//  private NaInt64 (SerializationInfo info, StreamingContext context)
//  {
...
//  }
  ...
  XmlSchema IXmlSerializable.GetSchema()
  {
    if (s_schema == null)
    {
      ...
      {
        if (s_schema == null)
          s_schema = NaTypeUtility.CreateXmlSchema (typeof(NaInt64).Name, "short");
      }
    }
    return s_schema;
  }
  ...
  void IXmlSerializable.ReadXml (XmlReader reader)
  {
    ...
    if (strValue != null)
      _value = XmlConvert.ToInt64 (strValue);
  }
  ...
  public static NaInt64 Parse (string s, NumberStyles styles, IFormatProvider provider)
  {
    if (s == null || s.Length == 0 || s == NullString)
      return NaInt64.Null;
    else return new NaInt64 (Int64.Parse(s, styles, provider));
  }
  ...
  /// </exception>
  public static explicit operator Int64 (NaInt64 value)
  {
    if (value.IsNull)
      throw NaNullValueException.AccessingMember ("NaInt64 to Int64 Conversion");
    return value._value;
  }
  ...
  public static implicit operator NaInt64 (SqlInt64 value)
  {
    if (value.IsNull)
      ...
      return new NaInt64 (value.Value);
  }
  ...
  public static implicit operator SqlInt64 (NaInt64 value)
  {
    if (value.IsNull)
      ...
      return new SqlInt64 (value.Value);
  }
  ...
  public static NaInt64 FromBoxedInt64 (object value)
  {
    ...
    if (! (value is Int64))
      throw new ArgumentException ("Must be a Int64 value", "value");

    return new NaInt64 ((Int64) value);
  }
  ...
  /// <summary>
  /// Gets the value of this <see cref="NaInt64"/> structure. This property is read-only.
  /// </summary>
  /// <value>
  /// An integer representing the value of this NaInt64 structure.
  /// </value>
  /// <exception cref="NaNullValueException">
  ...
  /// </summary>
  /// <value>
  /// An Object representing the value of this NaInt64 structure.
  /// </value>
  /// <exception cref="NaNullValueException">
  /// The property contains <see cref="Null"/>.
  /// </exception>
  ...
  /// <summary>
  /// Represents a null value that can be assigned to an instance of the <see cref="NaInt64"/> structure.
  /// </summary>
  /// <remarks>
  /// Null functions as a constant for the <see cref="NaInt64"/> structure.
  /// </remarks>
  public static readonly NaInt64 Null = new NaInt64 (true);
  ...
  /// an instance of the <see cref="NaInt64"/> structure.
  /// </summary>
  /// <remarks>
  /// Zero functions as a constant for the <see cref="NaInt64"/> structure.
  /// </remarks>
  public static readonly NaInt64 Zero = new NaInt64 (0);

  /// <summary>
  /// A constant representing the largest possible value of a NaInt64.
  /// </summary>
  public static readonly NaInt64 MaxValue = new NaInt64 (Int64.MaxValue);

  /// <summary>
  /// A constant representing the smallest possible value of a NaInt64.
  /// </summary>
  public static readonly NaInt64 MinValue = new NaInt64 (Int64.MinValue);
  ...
  /// <summary>
  /// Compares the supplied object parameter to the <see cref="Value"/> property of the <see cref="NaInt64"/> object.
  /// </summary>
  ...
  {
    if (! (obj is NaInt64))
      return false; // obj is a null reference or another type then NaInt64

    return Equals (this, (NaInt64) obj);
  }

  /// <summary>
  /// Compares the supplied <see cref="NaInt64"/> parameter to the <see cref="Value"/> property of this instance.
  /// </summary>
  ...
  /// equality logic.
  /// </remarks>
  public bool Equals (NaInt64 value)
  {
  ...
  /// equality logic.
  /// </remarks>
  public static bool Equals (NaInt64 x, NaInt64 y)
  {
    return x == y;
  }
  ...
  /// equality logic.
  /// </remarks>
  public static bool operator == (NaInt64 x, NaInt64 y)
  {
  ...
  /// equality logic.
  /// </remarks>
  public static bool NotEquals (NaInt64 x, NaInt64 y)
  {
    return x != y;
  }
  ...
  ///   </list>
  /// </returns>
  public int CompareTo (NaInt64 value)
  {
    if (this.IsNull)
    {
      if (value.IsNull)
  ...
  public static NaInt64 operator + (NaInt64 x, NaInt64 y)
  {
    ...
    checked
    {
      return new NaInt64 (x._value + y._value);
    }
  }
