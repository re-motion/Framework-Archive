...
/// <summary> Specialization of <see cref="TypeConverter"/> for values of the type <see cref="NaByte"/>. </summary>
/// <remarks> 
///   Conversion from and to <see cref="NaByte"/> values is supported for the values of the following types:
///   <see cref="string"/> and <see cref="byte"/>. It is also possible to convert from <see cref="DBNull"/> and
///   <see langword="null"/>.
/// </remarks>
public class NaByteConverter: TypeConverter
{
  ...
  /// <summary> Test: Can convert from <see cref="NaByte"/> to <paramref name="destinationType"/>? </summary>
  /// <param name="context"> An <see cref="ITypeDescriptorContext"/> that provides a format context. </param>
  /// <param name="destinationType"> The <see cref="Type"/>  to convert an <see cref="NaByte"/> value to. </param>
  /// <returns> <see langword="true"/> if the conversion is supported. </returns>
  ...
  /// <returns> An <see cref="NaByte"/> or <see cref="NaByte.Null"/> if the conversion failed.  </returns>
  ...
  /// <summary> Convertes an <see cref="NaByte"/> into the <paramref name="destinationType"/>. </summary>
  /// <param name="context"> An <see cref="ITypeDescriptorContext"/> that provides a format context. </param>
  /// <param name="culture"> The <see cref="CultureInfo"/> to use as the current culture. </param>
  /// <param name="value"> The <see cref="NaByte"/> to be converted. Must not be <see langword="null"/>. </param>
