...
namespace Remotion.Security
{
  ...
  public class SecurityPrincipal : ISecurityPrincipal, IEquatable<SecurityPrincipal>
  {
    ...
    public bool Equals (SecurityPrincipal other)
    {
      ...
      if (this._role != other._role && this._role != null && !this._role.Equals (other._role))
        return false;

      if (!string.Equals (this._substitutedUser, other._substitutedUser, StringComparison.Ordinal))
        return false;

      if (this._substitutedRole != other._substitutedRole && this._substitutedRole != null && !this._substitutedRole.Equals (other._substitutedRole))
        return false;
