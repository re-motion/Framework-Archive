...
namespace Remotion.Mixins.UnitTests.ValidationTests
{
  ...
  public class DelegateRuleDescriptionTest
  {
    ...
    public void DefaultDescription ()
    {
      ...
      Assert.AreEqual ("Remotion.Mixins.UnitTests.ValidationTests.DelegateRuleDescriptionTest.NonDescribedSampleRule", rule.RuleName);
    ...
    public void DescriptionAttribute_NoChanges ()
    {
      ...
      Assert.AreEqual ("Remotion.Mixins.UnitTests.ValidationTests.DelegateRuleDescriptionTest.DescribedSampleRule_NoChanges", rule.RuleName);
