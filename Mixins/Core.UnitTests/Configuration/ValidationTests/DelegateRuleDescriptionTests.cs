...
namespace Rubicon.Mixins.UnitTests.Configuration.ValidationTests
{
  [TestFixture]
  public class DelegateRuleDescriptionTests
  {
    ...
    public void DefaultDescription ()
    {
      ...
      Assert.AreEqual ("Rubicon.Mixins.UnitTests.Configuration.ValidationTests.DelegateRuleDescriptionTests.NonDescribedSampleRule", rule.RuleName);
    ...
    public void DescriptionAttribute_NoChanges ()
    {
      ...
      Assert.AreEqual ("Rubicon.Mixins.UnitTests.Configuration.ValidationTests.DelegateRuleDescriptionTests.DescribedSampleRule_NoChanges", rule.RuleName);
