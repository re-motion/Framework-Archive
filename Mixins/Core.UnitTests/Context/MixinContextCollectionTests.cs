...
{
  [TestFixture]
  public class MixinContextCollectionTests
  {
    ...
    public void ContainsAssignableMixin ()
    {
      ...
      Assert.IsFalse (_collection.ContainsAssignableMixin (typeof (MixinContextCollectionTests)));
    }
    ...
    public void ContainsOverrideForMixin ()
    {
      ...
      Assert.IsFalse (_collection.ContainsOverrideForMixin (typeof (MixinContextCollectionTests)));
    }
  }
}