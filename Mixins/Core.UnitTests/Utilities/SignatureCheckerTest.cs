...
namespace Remotion.Mixins.UnitTestsUtilities
{
  ...
  public class SignatureCheckerTest
  {
    ...
    {
      MethodInfo m1 = typeof (SignatureCheckerTest.GenericClass<,>).GetMethod ("Method");
      MethodInfo m2 = typeof (SignatureCheckerTest.GenericClass<,>).GetMethod ("Method2");
      MethodInfo m3 = typeof (SignatureCheckerTest.GenericClass<,>).GetMethod ("Method3");
