...
public sealed class BocListSortingOrderEntry
{
  ...
  /// </param>
  internal void SetColumn (IBocSortableColumnDefinition column)
  {
    ...
    if (_isEmpty)
      throw new InvalidOperationException ("Setting the column of the empty BocListSortingOrderEntry is not supported.");
