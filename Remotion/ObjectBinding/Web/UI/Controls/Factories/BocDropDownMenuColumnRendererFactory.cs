...
namespace Remotion.ObjectBinding.Web.UI.Controls.Factories
{
  public class BocDropDownMenuColumnRendererFactory : IBocDropDownMenuColumnRendererFactory
  {
    ...
    public IBocColumnRenderer CreateRenderer (HttpContextBase context, IBocList list, BocDropDownMenuColumnDefinition columnDefinition, IServiceLocator serviceLocator, int columnIndex)
    {
      ...
      return new BocDropDownMenuColumnRenderer (serviceLocator.GetInstance<IResourceUrlFactory> (), _bocListCssClassDefinition);
    }
  }
}