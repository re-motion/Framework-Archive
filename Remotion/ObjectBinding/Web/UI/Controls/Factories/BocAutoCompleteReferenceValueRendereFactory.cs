...
{
  /// <summary>
  /// Responsible for creating standard mode renderers for <see cref="IBocAutoCompleteReferenceValue"/> controls.
  /// </summary>
  public class BocAutoCompleteReferenceValueRendereFactory : IBocAutoCompleteReferenceValueRendererFactory
  {
    public IRenderer CreateRenderer (HttpContextBase context, IBocAutoCompleteReferenceValue control, IServiceLocator serviceLocator)
    {
      ...
      return new BocAutoCompleteReferenceValueRenderer (context, control, serviceLocator.GetInstance<IResourceUrlFactory>());
    }
  }
}