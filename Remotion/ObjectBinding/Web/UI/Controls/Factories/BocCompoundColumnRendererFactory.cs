...
namespace Remotion.ObjectBinding.Web.UI.Controls.Factories
{
  public class BocCompoundColumnRendererFactory : IBocCompoundColumnRendererFactory
  {
    ...
    public BocCompoundColumnRendererFactory (BocListCssClassDefinition bocListCssClassDefinition)
    {
    ...
    public IBocColumnRenderer CreateRenderer (HttpContextBase context, IBocList list, BocCompoundColumnDefinition columnDefinition, IServiceLocator serviceLocator, int columnIndex)
    {
      ...
      return new BocCompoundColumnRenderer (serviceLocator.GetInstance<IResourceUrlFactory> (), _bocListCssClassDefinition);
    }
  }
}