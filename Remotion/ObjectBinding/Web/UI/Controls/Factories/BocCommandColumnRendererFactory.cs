...
namespace Remotion.ObjectBinding.Web.UI.Controls.Factories
{
  public class BocCommandColumnRendererFactory : IBocCommandColumnRendererFactory
  {
    ...
    public IBocColumnRenderer CreateRenderer (HttpContextBase context, IBocList list, BocCommandColumnDefinition columnDefinition, IServiceLocator serviceLocator)
    {
