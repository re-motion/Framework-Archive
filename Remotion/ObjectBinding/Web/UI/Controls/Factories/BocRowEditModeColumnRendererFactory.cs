...
namespace Remotion.ObjectBinding.Web.UI.Controls.Factories
{
  public class BocRowEditModeColumnRendererFactory : IBocRowEditModeColumnRendererFactory
  {
    ...
    public IBocColumnRenderer CreateRenderer (HttpContextBase context, IBocList list, BocRowEditModeColumnDefinition columnDefinition, IServiceLocator serviceLocator, int columnIndex)
    {
      ...
      return new BocRowEditModeColumnRenderer (serviceLocator.GetInstance<IResourceUrlFactory> (), _bocListCssClassDefinition);
    }
  }
}