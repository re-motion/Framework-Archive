...
{
  [TestFixture]
  public class IDateTimeFormatterTest
  {
    ...
    {
      var instance1 = _serviceLocator.GetInstance<IDateTimeFormatter>();
      var instance2 = _serviceLocator.GetInstance<IDateTimeFormatter>();
