...
{
  [TestFixture]
  public class BocListQuirksModeCssClassDefinitionTest
  {
    [TestFixture]
    public class BocListCssClassDefinitionTest
    {
      ...
      {
        var factory1 = _serviceLocator.GetInstance<BocListQuirksModeCssClassDefinition> ();
        var factory2 = _serviceLocator.GetInstance<BocListQuirksModeCssClassDefinition> ();
