  ...
  public class CascadedPropertyPathTest
  {
    ...
    public void GetResult ()
    {
      ...
      var actual = _path.GetResult (
          ...
          BusinessObjectPropertyPathUnreachableValueBehavior.FailForUnreachableValue,
          BusinessObjectPropertyPathListValueBehavior.GetResultForFirstListEntry);
    ...
    public void GetResult_WithUnreachableObject ()
    {
      ...
      var actual = _path.GetResult (
          _testHelper.BusinessObject,
          BusinessObjectPropertyPathUnreachableValueBehavior.ReturnNullForUnreachableValue,
          BusinessObjectPropertyPathListValueBehavior.GetResultForFirstListEntry);
