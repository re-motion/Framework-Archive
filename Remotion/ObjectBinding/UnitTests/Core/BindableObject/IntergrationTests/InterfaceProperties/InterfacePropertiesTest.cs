...
using Remotion.ObjectBinding.UnitTests.Core.BindableObject.IntergrationTests.InterfaceProperties.TestDomain;

namespace Remotion.ObjectBinding.UnitTests.Core.BindableObject.IntergrationTests.InterfaceProperties
{
  [TestFixture]
