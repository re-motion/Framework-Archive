...
using Remotion.ObjectBinding.UnitTests.Core.BindableObject.IntergrationTests.MixedProperties.TestDomain;

namespace Remotion.ObjectBinding.UnitTests.Core.BindableObject.IntergrationTests.MixedProperties
{
  [TestFixture]
  public class PrivatelyIntroducedMixedPropertiesTest : TestBase
  {
    [Test]
