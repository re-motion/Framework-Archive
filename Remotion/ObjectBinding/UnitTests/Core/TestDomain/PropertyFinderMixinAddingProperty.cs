...
{
  public interface IPropertyFinderMixinAddingProperty
  {
  ...
  [Serializable]
  public class PropertyFinderMixinAddingProperty : IPropertyFinderMixinAddingProperty
  {
    ...
    string IPropertyFinderMixinAddingProperty.ExplicitMixedProperty
    {
      get { return _mixedProperty; }
      set { _mixedProperty = value; }
    }
