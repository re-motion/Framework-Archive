<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BocTextUserControlTestOutput.ascx.cs" Inherits="Remotion.ObjectBinding.Web.Development.WebTesting.TestSite.Controls.BocTextUserControlTestOutput" %>
<table border="1">
