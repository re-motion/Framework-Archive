...
namespace Remotion.ObjectBinding.Web.Legacy.UI.Controls.BocListImplementation.Rendering
{
  ...
  /// </summary>
  public class BocRowEditModeColumnQuirksModeRenderer : BocColumnQuirksModeRendererBase<BocRowEditModeColumnDefinition>
  {
    ...
    /// </remarks>
    public BocRowEditModeColumnQuirksModeRenderer (HttpContextBase context, IBocList list, BocRowEditModeColumnDefinition columnDefinition, BocListQuirksModeCssClassDefinition cssClasses, int columnIndex)
