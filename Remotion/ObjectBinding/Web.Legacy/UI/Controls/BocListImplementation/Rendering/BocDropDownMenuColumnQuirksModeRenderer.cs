...
namespace Remotion.ObjectBinding.Web.Legacy.UI.Controls.BocListImplementation.Rendering
{
  ...
  public class BocDropDownMenuColumnQuirksModeRenderer : BocColumnQuirksModeRendererBase<BocDropDownMenuColumnDefinition>
  {
    ...
    /// </remarks>
    public BocDropDownMenuColumnQuirksModeRenderer (HttpContextBase context, IBocList list, BocDropDownMenuColumnDefinition column, CssClassContainer cssClasses)
