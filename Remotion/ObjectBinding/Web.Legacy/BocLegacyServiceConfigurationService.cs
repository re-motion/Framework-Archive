...
namespace Remotion.ObjectBinding.Web.Legacy
{
  public static class BocLegacyServiceConfigurationService
  {
    public static IEnumerable<ServiceConfigurationEntry> GetConfiguration ()
    {
      ...
      yield return new ServiceConfigurationEntry (typeof (IBocCompoundColumnRenderer), typeof (BocCompoundColumnQuirksModeRenderer), LifetimeKind.Singleton);
      yield return new ServiceConfigurationEntry (typeof (IBocCustomColumnRenderer), typeof (BocCustomColumnQuirksModeRenderer), LifetimeKind.Singleton);
      yield return new ServiceConfigurationEntry (typeof (IBocDropDownMenuColumnRenderer), typeof (BocDropDownMenuColumnQuirksModeRenderer), LifetimeKind.Singleton);
      ...
      yield return new ServiceConfigurationEntry (typeof (IBocListMenuBlockRenderer), typeof (BocListMenuBlockQuirksModeRenderer), LifetimeKind.Singleton);
      yield return new ServiceConfigurationEntry (typeof (IBocListNavigationBlockRenderer), typeof (BocListNavigationBlockQuirksModeRenderer), LifetimeKind.Singleton);
      yield return new ServiceConfigurationEntry (typeof (BocListQuirksModeCssClassDefinition), typeof (BocListQuirksModeCssClassDefinition), LifetimeKind.Singleton);
      ...
      yield return new ServiceConfigurationEntry (typeof (IBocListTableBlockRenderer), typeof (BocListTableBlockQuirksModeRenderer), LifetimeKind.Singleton);
      yield return new ServiceConfigurationEntry (typeof (IBocRowEditModeColumnRenderer), typeof (BocRowEditModeColumnQuirksModeRenderer), LifetimeKind.Singleton);
