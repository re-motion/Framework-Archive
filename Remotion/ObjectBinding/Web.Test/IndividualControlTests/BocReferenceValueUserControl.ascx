...
<table id=FormGrid runat="server">
  ...
  <tr>
    <td></td>
    <td><remotion:bocreferencevalue id=PartnerField runat="server" readonly="False" datasourcecontrol="CurrentObject" propertyidentifier="Partner" width="100%" EnableSelectStatement="True">
<persistedcommand>
