...
namespace Remotion.Data.DomainObjects.DataManagement
{
  ...
  public class DataManager : ISerializable, IDeserializationCallback, IDataManager, ILazyLoader
  {
    ...
    public void LoadLazyCollectionEndPoint (ICollectionEndPoint collectionEndPoint)
    {
      ...
      var domainObjects = _objectLoader.GetOrLoadRelatedObjects (collectionEndPoint.ID, this, new LoadedObjectProvider (this, _invalidDomainObjectManager));
    ...
    public void LoadLazyVirtualObjectEndPoint (IVirtualObjectEndPoint virtualObjectEndPoint)
    {
      ...
      var domainObject = _objectLoader.GetOrLoadRelatedObject (virtualObjectEndPoint.ID, this, new LoadedObjectProvider (this, _invalidDomainObjectManager));
