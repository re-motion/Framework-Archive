...
{
  /// <summary>
  /// Defines the API of a listener that can be registered with the <see cref="PersistenceTracer"/>.
  /// </summary>
  public interface IPersistenceTraceListener
  {
    ...
    /// </summary>
    /// <param name="clientTransactionID">An ID uniquely identifying the <see cref="ClientTransaction"/> scoping this operation.</param>
