...
namespace Remotion.Data.UnitTests.DomainObjects.TestDomain.TableInheritance
{
  ...
  public abstract class BaseClassWithInvalidRelationClassIDColumns : DomainObject
  {
    ...
    public abstract TIClient Client { get; set; }

    public abstract TIDomainBase DomainBase { get; set; }

    public abstract TIDomainBase DomainBaseWithInvalidClassIDValue { get; set; }

    public abstract TIDomainBase DomainBaseWithInvalidClassIDNullValue { get; set; }
  }
}
