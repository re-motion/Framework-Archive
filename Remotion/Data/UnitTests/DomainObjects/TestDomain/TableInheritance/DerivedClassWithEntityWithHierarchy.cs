...
namespace Remotion.Data.UnitTests.DomainObjects.TestDomain.TableInheritance
{
  ...
  public abstract class DerivedClassWithEntityWithHierarchy: AbstractBaseClassWithHierarchy
  {
    ...
    public new static DerivedClassWithEntityWithHierarchy GetObject (IObjectID<DomainObject> id)
    {
    ...
    public abstract TIClient ClientFromDerivedClassWithEntity { get; set; }

    public abstract TIFileSystemItem FileSystemItemFromDerivedClassWithEntity { get; set; }
  }
}
