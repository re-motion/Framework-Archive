...
namespace Remotion.Data.UnitTests.DomainObjects.TestDomain.TableInheritance
{
  ...
  public abstract class DerivedClassWithEntityFromBaseClassWithHierarchy: DerivedClassWithEntityWithHierarchy
  {
    ...
    public new static DerivedClassWithEntityFromBaseClassWithHierarchy GetObject (IObjectID<DomainObject> id)
    {
    ...
    public abstract TIFileSystemItem FileSystemItemFromDerivedClassWithEntityFromBaseClass { get; set; }
  }
}
