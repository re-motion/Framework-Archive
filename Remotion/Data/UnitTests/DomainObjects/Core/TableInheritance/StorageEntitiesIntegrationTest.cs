...
{
  [TestFixture]
  public class StorageEntitiesIntegrationTest : TableInheritanceMappingTest
  {
    [Test]
    public void TableInheritanceBaseClass ()
    {
      var domainBaseClass = Configuration.GetTypeDefinition (typeof (DomainBase));
      Assert.That (domainBaseClass, Is.Not.Null);
      Assert.That (domainBaseClass.StorageEntityDefinition, Is.TypeOf<UnionViewDefinition> ());

      var personClass = Configuration.GetTypeDefinition (typeof (Person));
      ...
      var organizationalUnitClass = Configuration.GetTypeDefinition (typeof (OrganizationalUnit));
      ...
      var customerClass = Configuration.GetTypeDefinition (typeof (Customer));
