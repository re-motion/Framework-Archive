...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Linq.IntegrationTests
{
  ...
  public class FulltextIntegrationTests : IntegrationTestBase
  {
    ...
    public void Fulltext_Spike ()
    {
      ...
      var queryDefinition =
          new QueryDefinition ("bla", orderClassDefinition.StorageEntityDefinition.StorageProviderDefinition.Name, "SELECT * FROM CeoView WHERE Contains ([CeoView].[Name], 'Fischer')", QueryType.Collection);
