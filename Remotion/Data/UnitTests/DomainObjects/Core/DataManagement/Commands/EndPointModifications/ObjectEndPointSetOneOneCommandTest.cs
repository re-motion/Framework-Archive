...
namespace Remotion.Data.UnitTests.DomainObjects.Core.DataManagement.Commands.EndPointModifications
{
  ...
  public class ObjectEndPointSetOneOneCommandTest : ObjectEndPointSetCommandTestBase
  {
    ...
    public override void SetUp ()
    {
      ...
      _command = new ObjectEndPointSetOneOneCommand (_endPoint, _newRelatedObject, OppositeObjectIDSetter);
    }
    ...
    public void Initialization_FromNullEndPoint ()
    {
      ...
      new ObjectEndPointSetOneOneCommand (endPoint, _newRelatedObject, OppositeObjectIDSetter);
    }
    ...
    public void ExpandToAllRelatedObjects_SetDifferent_BidirectionalOneOne ()
    {
      ...
      Assert.That (steps[1], Is.InstanceOfType (typeof (RealObjectEndPointRegistrationCommandDecorator)));
