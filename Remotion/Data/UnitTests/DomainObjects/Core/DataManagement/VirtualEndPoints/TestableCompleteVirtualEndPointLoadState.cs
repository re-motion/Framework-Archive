...
{
  public class TestableCompleteVirtualEndPointLoadState : CompleteVirtualEndPointLoadStateBase<IVirtualEndPoint, object, IVirtualEndPointDataKeeper>
  {
    ...
    public override object GetData (IVirtualEndPoint endPoint)
    {
      throw new NotImplementedException();
    }

    public override object GetOriginalData (IVirtualEndPoint endPoint)
    {
      throw new NotImplementedException();
    }

    public override void SetValueFrom (IVirtualEndPoint endPoint, IVirtualEndPoint sourceEndPoint)
    {
      throw new NotImplementedException();
    }

    public override void Synchronize (IVirtualEndPoint endPoint)
    {
      throw new NotImplementedException();
    }
