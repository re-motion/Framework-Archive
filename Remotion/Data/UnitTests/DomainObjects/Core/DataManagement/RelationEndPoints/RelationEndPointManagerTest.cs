...
namespace Remotion.Data.UnitTests.DomainObjects.Core.DataManagement.RelationEndPoints
{
  ...
  public class RelationEndPointManagerTest : ClientTransactionBaseTest
  {
    ...
    public void GetOriginalRelatedObjectsWithEndPointIDOfWrongCardinality ()
    {
      ...
      _relationEndPointManager.GetOriginalRelatedObjects (RelationEndPointID.Create (order.ID, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket"));
    }
    ...
    public void GetOriginalRelatedObjectsWithLazyLoad ()
    {
      ...
      DomainObjectCollection originalOrderItems = _relationEndPointManager.GetOriginalRelatedObjects (endPointID);
      DomainObjectCollection orderItems = _relationEndPointManager.GetRelatedObjects (endPointID);
    ...
    {
      Order order = Order.GetObject (DomainObjectIDs.Order1);
      _relationEndPointManager.GetOriginalRelatedObject (RelationEndPointID.Create (order.ID, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems"));
    }
    ...
    public void GetOriginalRelatedObjectWithLazyLoad ()
    {
      ...
      DomainObject originalOrderTicket = _relationEndPointManager.GetOriginalRelatedObject (endPointID);
      DomainObject orderTicket = _relationEndPointManager.GetRelatedObject (endPointID, false);
    ...
    public void GetRelatedObjectIncludeDeletedFalse ()
    {
      ...
      _relationEndPointManager.GetRelatedObject (endPointID, false);
    }
    ...
    public void GetRelatedObjectIncludeDeletedTrue ()
    {
      ...
      var endPointID = RelationEndPointID.Create (location.ID, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Location.Client");
      DomainObject client = _relationEndPointManager.GetRelatedObject (endPointID, true);
    ...
    {
      Order order = Order.GetObject (DomainObjectIDs.Order1);
      _relationEndPointManager.GetRelatedObjects (RelationEndPointID.Create (order.ID, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket"));
    }
    ...
    {
      Order order = Order.GetObject (DomainObjectIDs.Order1);
      _relationEndPointManager.GetRelatedObject (RelationEndPointID.Create (order.ID, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems"), false);
    }
