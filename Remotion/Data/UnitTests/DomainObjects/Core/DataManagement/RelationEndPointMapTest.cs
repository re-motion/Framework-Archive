...
namespace Remotion.Data.UnitTests.DomainObjects.Core.DataManagement
{
  ...
  public class RelationEndPointMapTest : ClientTransactionBaseTest
  {
    ...
    {
      var dataContainer = DataContainer.CreateForExisting (DomainObjectIDs.Order1, null, pd => pd.DefaultValue);
      _map.GetEndPointIDsForUnload (dataContainer);
    }

    [Test]
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = "DataContainer must be unchanged.\r\nParameter name: dataContainer")]
    public void GetEndPointIDsForUnload_InvalidState ()
    {
      var dataContainer = DataContainer.CreateNew (DomainObjectIDs.Order1);
      _map.GetEndPointIDsForUnload (dataContainer);
    }
    ...
    public void GetEndPointIDsForUnload_RealEndPoint_Returned ()
    {
      ...
      CheckGetEndPointIDsForUnload_Returns (DomainObjectIDs.OrderTicket1, realEndPoint);
    }
    ...
    public void GetEndPointIDsForUnload_VirtualEndPointWithNullValue_Returned ()
    {
      ...
      _map.GetRelationEndPointWithLazyLoad (loadedVirtualEndPointWithNullValue);
      Assert.That (((ObjectEndPoint) _map[loadedVirtualEndPointWithNullValue]).OppositeObjectID, Is.Null);

      CheckGetEndPointIDsForUnload_Returns (DomainObjectIDs.Employee1, loadedVirtualEndPointWithNullValue);
    }
    ...
    public void GetEndPointIDsForUnload_OppositeVirtualObjectEndPoint_Returned ()
    {
      ...
      CheckGetEndPointIDsForUnload_Returns (DomainObjectIDs.OrderTicket1, oppositeVirtualObjectEndPoint);
    }
    ...
    public void GetEndPointIDsForUnload_OppositeVirtualCollectionEndPoint_Returned ()
    {
      ...
      _map.GetRelationEndPointWithLazyLoad (oppositeCollectionEndPoint);

      CheckGetEndPointIDsForUnload_Returns (DomainObjectIDs.OrderItem1, oppositeCollectionEndPoint);
    }
    ...
    public void GetEndPointIDsForUnload_VirtualObjectEndPoint_NotReturned ()
    {
      ...
      _map.GetRelationEndPointWithLazyLoad (virtualObjectEndPointID);

      CheckGetEndPointIDsForUnload_NotReturns (DomainObjectIDs.Order1, virtualObjectEndPointID);
    }
    ...
    public void GetEndPointIDsForUnload_VirtualObjectEndPoint_NullAndNotLoaded_NotReturned ()
    {
      ...
      Assert.That (_map[virtualObjectEndPointID], Is.Null);

      CheckGetEndPointIDsForUnload_NotReturns (DomainObjectIDs.Employee1, virtualObjectEndPointID);
    }
    ...
    public void GetEndPointIDsForUnload_VirtualCollectionEndPoint_NotReturned ()
    {
      ...
      _map.GetRelationEndPointWithLazyLoad (collectionEndPointID);

      CheckGetEndPointIDsForUnload_NotReturns (DomainObjectIDs.Order1, collectionEndPointID);
    }
    ...
    public void GetEndPointIDsForUnload_OppositeRealObjectEndPoint_NotReturned ()
    {
      ...
      _map.GetRelationEndPointWithLazyLoad (oppositeRealObjectEndPointID);

      CheckGetEndPointIDsForUnload_NotReturns (DomainObjectIDs.Order1, oppositeRealObjectEndPointID);
    }
    ...
    public void GetEndPointIDsForUnload_OppositeVirtualObjectEndPoint_OfNull_NotReturned ()
    {
      ...
      CheckGetEndPointIDsForUnload_NotReturns (DomainObjectIDs.Computer4, oppositeVirtualObjectEndPointID);

      Assert.That (((ObjectEndPoint) _map[realEndPointID]).OppositeObjectID, Is.Null);
    }
    ...
    public void GetEndPointIDsForUnload_OppositeVirtualCollectionEndPoint_NotLoaded_NotReturned ()
    {
      ...
      Assert.That (_map[oppositeCollectionEndPointID], Is.Null);

      CheckGetEndPointIDsForUnload_NotReturns (DomainObjectIDs.OrderItem1, oppositeCollectionEndPointID);
    }

    private void CheckGetEndPointIDsForUnload_Returns (ObjectID unloadedObject, RelationEndPointID expectedEndPointID)
    {
      ...
      var endPointIDs = _map.GetEndPointIDsForUnload (dataContainer);

      Assert.That (endPointIDs, List.Contains (expectedEndPointID));
    }

    private void CheckGetEndPointIDsForUnload_NotReturns (ObjectID unloadedObject, RelationEndPointID unexpectedEndPointID)
    {
      var domainObject = RepositoryAccessor.GetObject (ClientTransactionMock, unloadedObject, false);
      var dataContainer = ClientTransactionMock.DataManager.DataContainerMap[domainObject.ID];
