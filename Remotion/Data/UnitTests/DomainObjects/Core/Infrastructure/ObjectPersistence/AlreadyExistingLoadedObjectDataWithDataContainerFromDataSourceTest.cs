...
{
  [TestFixture]
  public class AlreadyExistingLoadedObjectDataWithDataContainerFromDataSourceTest : StandardMappingTest
  {
    private DataContainer _dataContainer;
    private DataContainer _dataContainerFromDataSource;

    private AlreadyExistingLoadedObjectDataWithDataContainerFromDataSource _loadedObjectData;
    ...
    public override void SetUp ()
    {
      ...
      _dataContainerFromDataSource = DataContainer.CreateNew (DomainObjectIDs.Order1);

      _loadedObjectData = new AlreadyExistingLoadedObjectDataWithDataContainerFromDataSource (_dataContainer, _dataContainerFromDataSource);
    }
    ...
    {
      var dataContainerFromDataSource = _loadedObjectData.GetDataContainerFromDataSource();

      Assert.That (dataContainerFromDataSource, Is.SameAs (_dataContainerFromDataSource));
    }
