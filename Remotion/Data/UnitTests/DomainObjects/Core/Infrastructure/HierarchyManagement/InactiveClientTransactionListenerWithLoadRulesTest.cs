...
{
  [TestFixture]
  public class InactiveClientTransactionListenerWithLoadRulesTest : StandardMappingTest
  {
    private InactiveClientTransactionListenerWithLoadRules _listener;
    ...
    public override void SetUp ()
    {
      ...
      _listener = new InactiveClientTransactionListenerWithLoadRules();
    ...
    public void PropertyValueChanging_SomeObject_ForbiddenInLoadMode ()
    {
      ...
      CheckForbiddenOperationWithLoadMode (
          ...
          + "(Modified property: 'Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderNumber'.)");
    }
    ...
    public void RelationChanging_SomeObject_ForbiddenInLoadMode ()
    {
      ...
      CheckForbiddenOperationWithLoadMode (
          ...
          "The object 'Order|5682f032-2f0b-494b-a31c-c97f02b89c36|System.Guid' cannot be modified. "
          + "(Modified property: 'Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket'.)");
    }
