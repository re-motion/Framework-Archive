...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.Validation.Logical
{
  ...
  public class RelationEndPointCombinationIsSupportedValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void TwoAnonymousRelationEndPoints ()
    {
      ...
      var expectedMessage = "Relation 'Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.Order.Customer' "
        +"cannot have two anonymous end points.";
