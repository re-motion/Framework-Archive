...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration
{
  ...
  public abstract class OrderWithNewPropertyAccess: DomainObject
  {
    ...
    {
      get { return Properties["Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.OrderWithNewPropertyAccess.Customer"].GetOriginalValue<Customer>(); }
    }
