...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration
{
  ...
  public abstract class OrderItemWithNewPropertyAccess : DomainObject
  {
    ...
    {
      get { return Properties["Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.OrderItemWithNewPropertyAccess.Order"].GetOriginalValue <OrderWithNewPropertyAccess>(); }
    }
  }
}
