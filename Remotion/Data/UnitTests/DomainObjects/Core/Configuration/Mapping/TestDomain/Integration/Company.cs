...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration
{
  ...
  public abstract class Company : TestDomainBase
  {
    ...
    {
      set { Properties["Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.Company.Name"].SetValue (value); }
    }
    ...
    {
      get { return (ClassWithoutRelatedClassIDColumnAndDerivation) GetRelatedObject ("Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.Company.ClassWithoutRelatedClassIDColumnAndDerivation"); }
      set { SetRelatedObject ("Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.Company.ClassWithoutRelatedClassIDColumnAndDerivation", value); }
    }
  }
}
