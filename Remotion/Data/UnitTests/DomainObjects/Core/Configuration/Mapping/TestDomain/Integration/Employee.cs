...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration
{
  ...
  public abstract class Employee : TestDomainBase
  {
    ...
    {
      get { return Properties["Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.Employee.Computer"].GetValue<Computer>(); }
      set { Properties["Remotion.Data.UnitTests.DomainObjects.Core.Configuration.Mapping.TestDomain.Integration.Employee.Computer"].SetValue (value); }
    }
