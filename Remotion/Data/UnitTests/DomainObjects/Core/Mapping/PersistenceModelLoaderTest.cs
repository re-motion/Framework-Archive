...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping
{
  ...
  public class PersistenceModelLoaderTest
  {
    ...
    public void SetUp ()
    {
      ...
      _classDefinition = ClassDefinitionFactory.CreateClassDefinitionWithoutStorageEntity (typeof (Order), null);
    ...
    public void ApplyPersistenceModelToHierarchy ()
    {
      ...
      _storageProviderDefinitionStub.Stub (stub => stub.GetStorageProviderDefinition (_classDefinition.StorageGroupType, null)).Return (
