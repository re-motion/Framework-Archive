...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping
{
  ...
  public class PersistentMixinFinderTest
  {
    ...
    [ExpectedException (typeof (MappingException), ExpectedMessage = "The persistence-relevant mixin "
        + "Remotion.Data.UnitTests.DomainObjects.Core.Mapping.PersistentMixinFinderTest+PersistedGenericMixin`1 applied to class "
        + "Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Order has open generic type parameters. All type parameters of the mixin must be "
    ...
    [Test]
    [ExpectedException (typeof (MappingException), ExpectedMessage = "Class 'Remotion.Data.UnitTests.DomainObjects.Core.Mapping."
