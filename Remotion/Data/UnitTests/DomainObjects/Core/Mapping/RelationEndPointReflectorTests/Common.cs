  ...
  public class Common : MappingReflectionTestBase
  {
    ...
    public void CreateRelationEndPointReflector ()
    {
      ...
      Assert.IsInstanceOf (
          ...
          RelationEndPointReflector.CreateRelationEndPointReflector (
              ClassDefinitionObjectMother.CreateClassDefinition (type), propertyInfo, Configuration.NameResolver, DomainModelConstraintProviderStub));
    }
    ...
    public void GetMetadata_NonVirtualEndPoint_PropertyTypeIsNotObjectID ()
    {
      ...
      var propertyDefinition = 
          PropertyDefinitionObjectMother.CreateForFakePropertyInfo(classDefinition, "Unidirectional", "Column", typeof (string), StorageClass.Persistent);
