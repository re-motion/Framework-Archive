...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Errors.ValidationIntegration.AttributesOnUnsupportedTypes
{
  [DBTable]
  ...
  {
    [StringProperty]
    public int IntPropertyWithStringPropertyAttribute { get; set; }

    [BinaryProperty]
    public bool BoolPropertyWithBinaryPropertyAttribute { get; set; }

    [ExtensibleEnumProperty]
    public string StringPropertyWithExtensibleEnumPropertyAttribute { get; set; }
