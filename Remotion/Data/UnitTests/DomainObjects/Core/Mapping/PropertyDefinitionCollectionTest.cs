...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping
{
  ...
  public class PropertyDefinitionCollectionTest : MappingReflectionTestBase
  {
    ...
    public override void SetUp ()
    {
      ...
      _classDefinition = ClassDefinitionFactory.CreateClassDefinition ("Order", "Order", UnitTestDomainStorageProviderDefinition, typeof (Order), false);
      ...
      _propertyDefinitionNonPersisted = PropertyDefinitionFactory.CreateForFakePropertyInfo (
    ...
    public void CreateForAllPropertyDefinitions_ClassDefinitionWithBaseClassDefinition ()
    {
      ...
      var propertyDefinitionInDerivedClass = PropertyDefinitionFactory.CreateForFakePropertyInfo (
