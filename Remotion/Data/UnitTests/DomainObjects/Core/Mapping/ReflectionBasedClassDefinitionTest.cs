...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping
{
  ...
  public class ReflectionBasedClassDefinitionTest : MappingReflectionTestBase
  {
    ...
    public void GetRelationDefinition ()
    {
      ...
      Assert.AreEqual ("Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Order.Customer", relation.ID);
    }
    ...
    public void GetAllRelationDefinitions_Contents ()
    {
      ...
      Assert.IsNotNull (relations["Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Ceo.Company"]);
      Assert.IsNotNull (relations["Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Partner.ContactPerson"]);
      Assert.IsNotNull (
          relations[
      ...
      Assert.IsNotNull (relations["Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Company.IndustrialSector"]);
    }
    ...
    public void GetRelationDefinitionsCompositeBaseClass ()
    {
      ...
      Assert.IsNotNull (
          relations["Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.FileSystemItem.ParentFolder"]);
    }
