...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping
{
  ...
  public class RelationDefinitionWithAnonymousRelationEndPointTest : MappingReflectionTestBase
  {
    ...
    public override void SetUp ()
    {
      ...
      _relation = FakeMappingConfiguration.Current.RelationDefinitions.GetMandatory ("Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Location->Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Location.Client");
    ...
    {
      Assert.AreSame (FakeMappingConfiguration.Current.ClassDefinitions[typeof (Client)], _relation.GetOppositeClassDefinition ("Location", "Remotion.Data.UnitTests.DomainObjects.Core.Mapping.TestDomain.Integration.Location.Client"));
