...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping.Validation.Reflection
{
  ...
  public class InheritanceHierarchyFollowsClassHierarchyValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void ClassDefinitionWithBaseClass_ClassTypeIsDerivedFromBaseClassType ()
    {
      ...
      var baseClassDefinition = ClassDefinitionFactory.CreateClassDefinition (baseType.Name, baseType.Name, StorageProviderDefinition, baseType, false);
      var derivedType = typeof (BaseValidationDomainObjectClass);
      var classDefinition = ClassDefinitionFactory.CreateClassDefinition (derivedType.Name, derivedType.Name, StorageProviderDefinition, derivedType, false, baseClassDefinition, new Type[0]);
