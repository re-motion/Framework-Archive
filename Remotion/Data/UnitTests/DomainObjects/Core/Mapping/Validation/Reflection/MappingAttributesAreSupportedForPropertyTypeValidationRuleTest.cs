...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping.Validation.Reflection
{
  ...
  public class MappingAttributesAreSupportedForPropertyTypeValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void ValidPropertyWithStringPropertyAttribute ()
    {
      ...
      var propertyDefinition = PropertyDefinitionObjectMother.Create(_classDefinition, StorageClass.Persistent, propertyInfo);
    ...
    public void SeveralInvalidProperties ()
    {
      ...
      var propertyDefinition1 = PropertyDefinitionObjectMother.Create(_classDefinition, StorageClass.Persistent, propertyInfo1);

      var propertyInfo2 = _invalidType.GetProperty ("StringPropertyWithExtensibleEnumPropertyAttribute");
      var propertyDefinition2 = PropertyDefinitionObjectMother.Create(_classDefinition, StorageClass.Persistent, propertyInfo2);

      var propertyInfo3 = _invalidType.GetProperty ("BoolPropertyWithBinaryPropertyAttribute");
      var propertyDefinition3 = PropertyDefinitionObjectMother.Create(_classDefinition, StorageClass.Persistent, propertyInfo3);
