...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping.Validation.Reflection
{
  ...
  public class MappingAttributesAreSupportedForPropertyTypeValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void SetUp ()
    {
      ...
      _classDefinition = ClassDefinitionObjectMother.CreateClassDefinition (_validType.Name, _validType.Name, StorageProviderDefinition, _validType, false);
    }
    ...
    public void ValidPropertyWithStringPropertyAttribute ()
    {
      ...
      var propertyDefinition = PropertyDefinitionFactory.Create(_classDefinition, StorageClass.Persistent, propertyInfo);
    ...
    public void SeveralInvalidProperties ()
    {
      ...
      var propertyDefinition1 = PropertyDefinitionFactory.Create(_classDefinition, StorageClass.Persistent, propertyInfo1);

      var propertyInfo2 = _invalidType.GetProperty ("StringPropertyWithExtensibleEnumPropertyAttribute");
      var propertyDefinition2 = PropertyDefinitionFactory.Create(_classDefinition, StorageClass.Persistent, propertyInfo2);

      var propertyInfo3 = _invalidType.GetProperty ("BoolPropertyWithBinaryPropertyAttribute");
      var propertyDefinition3 = PropertyDefinitionFactory.Create(_classDefinition, StorageClass.Persistent, propertyInfo3);
