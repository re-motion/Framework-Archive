...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping.Validation.IntegrationTests
{
  ...
  public class NotSupportedDomainObjectTypes : ValidationIntegrationTestBase
  {
    ...
    [ExpectedException (typeof (MappingException), 
      ExpectedMessage = "The domain object type has a legacy infrastructure constructor for loading (a nonpublic constructor taking a single DataContainer argument). The reflection-based mapping does not use this constructor any longer and requires it to be removed.")]
