...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Mapping.Validation
{
  ...
  public class PersistenceMappingValidatorTest
  {
    ...
    private IPersistenceMappingValidationRule _validationRuleMock1;
    private IPersistenceMappingValidationRule _validationRuleMock2;
    private IPersistenceMappingValidationRule _validationRuleMock3;
    ...
    public void SetUp ()
    {
      ...
      _classDefinition1 = ClassDefinitionObjectMother.CreateClassDefinition (type.Name, type.Name, storageProviderDefinition, type, false);
      _classDefinition2 = ClassDefinitionObjectMother.CreateClassDefinition (type.Name, type.Name, storageProviderDefinition, type, false);
      _classDefinition3 = ClassDefinitionObjectMother.CreateClassDefinition (type.Name, type.Name, storageProviderDefinition, type, false);
      ...
      _validationRuleMock3 = MockRepository.GenerateStrictMock<IPersistenceMappingValidationRule> ();
