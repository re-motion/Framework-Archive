...
{
  [TestFixture]
  public class ModificationsInLoadEventTest : InactiveTransactionsTestBase
  {
    ...
    public void OnLoaded_CanModifyThisObject_PropertyValues ()
    {
      using (_loadEventReceiverMock.GetMockRepository().Ordered())
      {
        _loadEventReceiverMock
            ...
            .WhenCalled (mi => CheckTransactionAndSetProperty (InactiveRootTransaction, _order, o => o.OrderNumber, expectedValue: 1, newValue: 2));
        _loadEventReceiverMock
            .Expect (mock => mock.OnLoaded (_order))
            .WhenCalled (mi => CheckTransactionAndSetProperty (InactiveMiddleTransaction, _order, o => o.OrderNumber, expectedValue: 2, newValue: 3));
        _loadEventReceiverMock
            .Expect (mock => mock.OnLoaded (_order))
    ...
    public void OnLoaded_CanModifyThisObject_UnidirectionalRelations ()
    {
      using (_loadEventReceiverMock.GetMockRepository().Ordered())
      {
        _loadEventReceiverMock
            ...
            .WhenCalled (mi => CheckTransactionAndSetProperty (InactiveRootTransaction, _location, l => l.Client, expectedValue: _client1, newValue: _client2));
        _loadEventReceiverMock
            .Expect (mock => mock.OnLoaded (_location))
            .WhenCalled (mi => CheckTransactionAndSetProperty (InactiveMiddleTransaction, _location, l => l.Client, expectedValue: _client2, newValue: _client3));
        _loadEventReceiverMock
            .Expect (mock => mock.OnLoaded (_location))
