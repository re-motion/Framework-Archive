      ...
      using (new ServiceLocatorScope (typeof (StorageObjectFactoryFake), typeof (DerivedStorageObjectFactoryFakeWithUnresolvedCtorParameter)))
      {
        ...
        Assert.That (
          ...
          Throws.TypeOf<ConfigurationErrorsException> ().With.Message.EqualTo (
              ...
              + "specified in the configuration of the 'TestProvider' StorageProvider definition cannot be resolved: Cannot get a concrete "
              + "implementation of type 'System.String': Expected 'ConcreteImplementationAttribute' could not be found."));
      }
    }
