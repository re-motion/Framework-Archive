  ...
  public class MultiObjectIDLoadCommandTest : SqlProviderBaseTest
  {
    ...
    public override void SetUp ()
    {
      ...
      _command = new MultiObjectIDLoadCommand (
          new[] { _dbCommandBuilder1Stub, _dbCommandBuilder2Stub }, _commandExecutionContextStub, _objectIDFactoryStub);
    ...
    public void Execute_OneDbCommandBuilder ()
    {
      ...
      var command = new MultiObjectIDLoadCommand (new[] { _dbCommandBuilder1Stub }, _commandExecutionContextStub, _objectIDFactoryStub);
