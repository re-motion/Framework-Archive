  ...
  public class SqlTableScriptBuilderTest : SchemaGenerationTestBase
  {
    ...
    public void AddToCreateTableScript ()
    {
      ...
      _tableBuilder.AddToCreateTableScript (
          (TableDefinition) MappingConfiguration.GetTypeDefinition (typeof (Ceo)).StorageEntityDefinition, stringBuilder);
    ...
    public void AddToDropTableScript ()
    {
      ...
      _tableBuilder.AddToDropTableScript (
          (TableDefinition) MappingConfiguration.GetTypeDefinition (typeof (Customer)).StorageEntityDefinition, stringBuilder);
    ...
    {
      _tableBuilder.AddEntityDefinition ((IEntityDefinition) MappingConfiguration.GetTypeDefinition (typeof (Customer)).StorageEntityDefinition);
      _tableBuilder.AddEntityDefinition ((IEntityDefinition) MappingConfiguration.GetTypeDefinition (typeof (Order)).StorageEntityDefinition);
