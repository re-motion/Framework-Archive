...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Persistence.Rdbms.SqlServer.IntegrationTests
{
  ...
  public class SqlProviderLoadDataContainersByRelatedID : SqlProviderBaseTest
  {
    ...
    public void Loading ()
    {
      ...
      Assert.IsNotNull (collection.SingleOrDefault(o=>o.ID==DomainObjectIDs.Order5), "ID of Order with OrdnerNo 2");
    }
    ...
    public void LoadWithOrderBy ()
    {
      ...
      Assert.That (orderContainers[1].ID, Is.EqualTo (DomainObjectIDs.Order5));
    }
