...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Persistence.Rdbms.SqlServer.SchemaGeneration
{
  ...
  public class TableBuilderTest : SchemaGenerationTestBase
  {
    ...
    //TODO Review 3632: Add an AbstractClass, DerivedAbstractClass, and DerivedDerivedConcreteClass to the schema generation test domain. Compare the table definition generated by the integration test in FileBuilderTest with the script below - they should be equal. Adapt SetupDB_FirstStorageProvider.sql. Then, remove this test.
    [Test]
    public void AddToCreateTableScriptWithTwoAbstractBaseClasses ()
    {
      ...
      ApplyPersistenceModel (abstractClass);
