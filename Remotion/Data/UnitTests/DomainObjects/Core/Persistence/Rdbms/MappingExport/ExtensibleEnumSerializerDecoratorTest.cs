  ...
  public class ExtensibleEnumSerializerDecoratorTest : SchemaGenerationTestBase
  {
    ...
    public void Serialize_AddsValueElementsForExtensibleEnumType ()
    {
      ...
      Assert.That (
          ...
          Is.EqualTo ("Remotion.Data.UnitTests.DomainObjects.Core.Persistence.Rdbms.SchemaGenerationTestDomain.ColorExtensions.Blue"));
      ...
      Assert.That (
          ...
          Is.EqualTo ("Remotion.Data.UnitTests.DomainObjects.Core.Persistence.Rdbms.SchemaGenerationTestDomain.ColorExtensions.Green"));
      ...
      Assert.That (
          ...
          Is.EqualTo ("Remotion.Data.UnitTests.DomainObjects.Core.Persistence.Rdbms.SchemaGenerationTestDomain.ColorExtensions.Red"));
    }
