...
namespace Remotion.Data.DomainObjects.PerformanceTests
{
  ...
  public class BindableObjectWithSecurityTest : BindableObjectTestBase
  {
    ...
    {
      Console.WriteLine (
          "Expected average duration of BindableObjectWithSecurityTest for BusinessObject_Property_IsAccessible on reference system: ~1.8 탎 (release build), ~3.7 탎 (debug build)");
    ...
    {
      Console.WriteLine (
          "Expected average duration of BindableObjectWithSecurityTest for BusinessObject_GetProperty on reference system: ~5.9 탎 (release build), ~12.2 탎 (debug build)");
    ...
    {
      Console.WriteLine (
          "Expected average duration of BindableObjectWithSecurityTest for DynamicMethod_GetProperty on reference system: ~4.5 탎 (release build), ~9.0 탎 (debug build)");
    ...
    {
      Console.WriteLine (
          "Expected average duration of BindableObjectWithSecurityTest for DomainObject_GetProperty on reference system: ~4.2 탎 (release build), ~8.9 탎 (debug build)");
    ...
    {
      Console.WriteLine (
          "Expected average duration of BindableObjectWithSecurityTest for BusinessObject_SetProperty on reference system: ~6.0 탎 (release build), ~11.8 탎 (debug build)");
    ...
    {
      Console.WriteLine (
          "Expected average duration of BindableObjectWithSecurityTest for DomainObject_SetProperty on reference system: ~5.8 탎 (release build), ~11.3 탎 (debug build)");
