...
namespace Remotion.Data.DomainObjects.PerformanceTests
{
  ...
  public class ClassDefinitionTest : DatabaseTest
  {
    ...
    public void GetOppositeClassDefinition ()
    {
      ...
      var classDefinition = MappingConfiguration.Current.TypeDefinitions.GetMandatory (typeof (ClassWithRelationProperties));
      ...
      for (int i = 0; i < TestRepititions; i++)
        found &= classDefinition.GetOppositeClassDefinition (endPoints[i % endPoints.Count].PropertyName) != null;
      stopwatch.Stop();
