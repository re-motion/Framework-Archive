...
namespace Remotion.Security.UnitTests.Core.Metadata.PermissionReflectorTests
{
  ...
  public class GetRequiredMethodPermissionsTest
  {
    ...
    public void Test_MethodWithoutAttributes_MethodInformation ()
    {
      ...
      Enum[] requiredAccessTypes = _permissionReflector.GetRequiredMethodPermissions (typeof (SecurableObject), methodInformation, MemberAffiliation.Instance);
    ...
    public void Test_CacheForMethodWithoutAttributes_MethodInformation ()
    {
      ...
      Assert.AreEqual (requiredAccessTypes, _permissionReflector.GetRequiredMethodPermissions (typeof (SecurableObject), methodInformation, MemberAffiliation.Instance));
    }
    ...
    public void Test_CacheForMethodWithOneAttribute_MethodInformation ()
    {
      ...
      Assert.AreSame (requiredAccessTypes, _permissionReflector.GetRequiredMethodPermissions (typeof (SecurableObject), methodInformation, MemberAffiliation.Instance));
    }
    ...
    public void Test_MethodOfDerivedClass_MethodInformation ()
    {
      ...
      Enum[] requiredAccessTypes = _permissionReflector.GetRequiredMethodPermissions (typeof (DerivedSecurableObject), methodInformation, MemberAffiliation.Instance);
