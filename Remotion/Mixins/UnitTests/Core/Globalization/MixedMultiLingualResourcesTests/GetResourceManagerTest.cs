...
namespace Remotion.Mixins.UnitTests.Core.Globalization.MixedMultiLingualResourcesTests
{
  ...
  public class GetResourceManagerTest
  {
    ...
    public void AttributesOnClass ()
    {
      ...
      Assert.That (resourceManager.ResourceManagers.Count(), Is.EqualTo (1));
      Assert.That (resourceManager.ResourceManagers.ElementAt (0).Name, Is.EqualTo ("OnTarget"));
    }
    ...
    public void AttributesOnBaseAndClass_InheritedDefault ()
    {
      ...
      Assert.That (resourceManager.ResourceManagers.Count(), Is.EqualTo (1));
      Assert.That (resourceManager.ResourceManagers.ElementAt (0).Name, Is.EqualTo ("OnInherited"));
    }
    ...
    public void AttributesOnBaseAndClass_InheritedTrue ()
    {
      ...
      Assert.That (resourceManager.ResourceManagers.Count(), Is.EqualTo (2));
      Assert.That (
          new[] { resourceManager.ResourceManagers.ElementAt (0).Name, resourceManager.ResourceManagers.ElementAt (1).Name },
          Is.EquivalentTo (new[] { "OnTarget", "OnInherited" }));
    }
    ...
    public void AttributesFromMixin_InheritedFalse ()
    {
                               ...
                               .EnterScope())
      {
        ...
        Assert.That (resourceManager.ResourceManagers.Count(), Is.EqualTo (1));
        Assert.That (resourceManager.ResourceManagers.ElementAt (0).Name, Is.EqualTo ("OnMixin1"));
      }
    }
    ...
    public void AttributesFromMultipleMixins_InheritedFalse ()
    {
                               ...
                               .EnterScope())
      {
        ...
        Assert.That (resourceManager.ResourceManagers.Count(), Is.EqualTo (3));
        Assert.That (
            new[]
            {
                resourceManager.ResourceManagers.ElementAt (0).Name, resourceManager.ResourceManagers.ElementAt (1).Name,
                resourceManager.ResourceManagers.ElementAt (2).Name
            },
    ...
    public void AttributesFromMixinsAndBaseAndClass_InheritedFalse ()
    {
                               ...
                               .EnterScope())
      {
        ...
        Assert.That (resourceManager.ResourceManagers.Count(), Is.EqualTo (4));
        Assert.That (
            new[]
            {
                resourceManager.ResourceManagers.ElementAt (0).Name, resourceManager.ResourceManagers.ElementAt (1).Name,
                resourceManager.ResourceManagers.ElementAt (2).Name, resourceManager.ResourceManagers.ElementAt (3).Name
            },
    ...
    public void AttributesFromMixinsAndBaseAndClass_InheritedTrue ()
    {
                               ...
                               .EnterScope())
      {
        ...
        Assert.That (resourceManager.ResourceManagers.Count(), Is.EqualTo (5));
        Assert.That (
            new[]
            {
                resourceManager.ResourceManagers.ElementAt (0).Name, resourceManager.ResourceManagers.ElementAt (1).Name,
                resourceManager.ResourceManagers.ElementAt (2).Name, resourceManager.ResourceManagers.ElementAt(3).Name,
                resourceManager.ResourceManagers.ElementAt(4).Name
            },
    ...
    public void Cache ()
    {
      ...
      Assert.That (((ResourceManagerSet) set1).ResourceManagers.Count(), Is.EqualTo (2));
      Assert.That (((ResourceManagerSet) set2).ResourceManagers.Count(), Is.EqualTo (5));
    }
  }
}