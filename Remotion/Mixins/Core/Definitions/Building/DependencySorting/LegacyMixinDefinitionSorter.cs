...
namespace Remotion.Mixins.Definitions.Building.DependencySorting
{
  ...
  public class LegacyMixinDefinitionSorter : IMixinDefinitionSorter
  {
    private readonly IDependentMixinGrouper _grouper;
    private readonly IDependentMixinSorter _sorter;

    public LegacyMixinDefinitionSorter (IDependentMixinGrouper grouper, IDependentMixinSorter sorter)
    {
      _grouper = grouper;
      _sorter = sorter;
    }
