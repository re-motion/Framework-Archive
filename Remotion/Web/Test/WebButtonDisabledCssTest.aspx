...
<body>
  <form id="form1" runat="server">
    <div>
      ...
      expected:
      <button type="submit" value="Enabled" class="testClass" disabled="disabled" ><span class="buttonBody">Enabled</span></button>
      <br />
      ...
      expected:
      <button type="submit" value="Enabled" class="webButton disabled" disabled="disabled" ><span class="buttonBody">Enabled</span></button>
      <br />
