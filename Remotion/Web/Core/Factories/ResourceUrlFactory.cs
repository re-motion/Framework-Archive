...
namespace Remotion.Web.Factories
{
  ...
  {
    public static ResourceUrlFactory CreateFromServiceLocator (IServiceLocator serviceLocator)
    {
      ArgumentUtility.CheckNotNull ("serviceLocator", serviceLocator);

      return new ResourceUrlFactory (serviceLocator.GetInstance<ResourceTheme>());
    }
