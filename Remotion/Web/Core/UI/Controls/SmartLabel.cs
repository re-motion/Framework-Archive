...
{
  [Obsolete ("Use IHotkeyParser and IHotkeyFormatter for analyzing and formatting hotkey-enabled strings. (Version 1.13.169)", true)]
  public static string FormatLabelText (string rawString, bool underlineAccessKey)
  {
    throw new NotImplementedException ("Obsolete. Use IHotkeyParser and IHotkeyFormatter for analyzing and formatting hotkey-enabled strings instead.");
  }
