...
namespace Remotion.Web.UI.Controls
{
  ...
  ///   </para>
  /// </remarks>
  public class DatePickerPage : Page, IPage
  {
    ...
    {
      if (Form == null)
        throw new HttpException (GetType().FullName + " does not initialize field 'Form'.");
      if (HtmlHeadContents == null)
        throw new HttpException (GetType().FullName + " does not initialize field 'HtmlHeadContents'.");
      if (Calendar == null)
        throw new HttpException (GetType().FullName + " does not initialize field 'Calendar'.");
