...
namespace Remotion.Web.UI.Controls.Rendering.ListMenu
{
  public class ListMenuPreRenderer : PreRendererBase<IListMenu>, IListMenuPreRenderer
  {
    ...
    public override void PreRender ()
    {
      ...
      if (!Control.Page.ClientScript.IsStartupScriptRegistered (typeof (IListMenu), key))
      {
        ...
        Control.Page.ClientScript.RegisterStartupScriptBlock (Control, typeof (IListMenu), key, script.ToString ());
      }
    }
