...
{
  public abstract class WebTabStripPreRendererBase : PreRendererBase<IWebTabStrip>, IWebTabStripPreRenderer
  {
    protected WebTabStripPreRendererBase (IHttpContext context, IWebTabStrip control)
