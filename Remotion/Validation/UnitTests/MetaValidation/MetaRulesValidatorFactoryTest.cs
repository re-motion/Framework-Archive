...
namespace Remotion.Validation.UnitTests.MetaValidation
{
  ...
  public class MetaRulesValidatorFactoryTest
  {
    ...
    {
      var systemMetaRulesProviderStub = MockRepository.GenerateStub<ISystemMetaValidationRulesProvider>();

      var factory = new MetaRulesValidatorFactory (mi=>systemMetaRulesProviderStub);
