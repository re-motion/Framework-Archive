...
{
  public class DerivedMetaValidationTestClass1 : BaseMetaValidationTestClass1
  {
    public override String Property1 { get; set; }
    public override String Property2 { get; set; }
    public override String Property3 { get; set; }
    public override String Property4 { get; set; }
    public override String Property5 { get; set; }
