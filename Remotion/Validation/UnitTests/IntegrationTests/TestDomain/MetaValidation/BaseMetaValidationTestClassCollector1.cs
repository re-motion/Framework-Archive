...
{
  public class BaseMetaValidationTestClassCollector1 : ComponentValidationCollector<BaseMetaValidationTestClass1>
  {
    public BaseMetaValidationTestClassCollector1 ()
    {
