...
using Remotion.Validation.Mixins.UnitTests.TestHelpers;
...
{
  [TestFixture]
  public class FluentValidationBuilderTest
  {
    ...
    [Test]
    public void BuildValidator_CollectorValidationFailedForMixin ()
    {
      ExpectMocks ();
