...
public class CommandLineParser
{
  ...
  /// </summary>
  /// <include file='..\doc\include\CommandLine\CommandLineParser.xml' path='CommandLineParser/SplitCommandLine/*' />
  /// <include file='..\doc\include\CommandLine\CommandLineParser.xml' path='CommandLineParser/Parameters/param[@name="includeFirstArgument"]' />
  ...
  /// </summary>
  /// <include file='..\doc\include\CommandLine\CommandLineParser.xml' path='CommandLineParser/Parameters/param[@name="commandLine" or @name="includeFirstArgument"]' />
