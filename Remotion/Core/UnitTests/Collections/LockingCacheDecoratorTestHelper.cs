...
{
  public class LockingCacheDecoratorTestHelper
  {
    ...
    public static bool TryAcquireLockFromOtherThread<TKey, TValue> (LockingCacheDecorator<TKey, TValue> lockingCacheDecorator)
    {
      var innerDataStore =
          lockingCacheDecorator;
