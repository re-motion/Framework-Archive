...
{
  /// <summary>
  /// Creates a <see cref="ExtensibleEnumConverter"/> if the requested type is an extensible enum.
  /// </summary>
  public class ExtensibleEnumTypeConverterFactory : TypeConversionProvider.ITypeConverterFactory
  {
