...
public class CommandLineParser
{
  ...
  /// <include file='..\..\doc\include\Text\CommandLine\CommandLineParser.xml' path='CommandLineParser/Parameters/param[@name="includeFirstArgument"]' />
  ...
  /// </summary>
  /// <include file='..\..\doc\include\Text\CommandLine\CommandLineParser.xml' path='CommandLineParser/Parameters/param[@name="commandLine" or @name="includeFirstArgument"]' />
