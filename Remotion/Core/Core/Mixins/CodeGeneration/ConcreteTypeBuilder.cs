...
namespace Remotion.Mixins.CodeGeneration
{
  ...
  /// The <see cref="IModuleManager"/> can be customized by providing a custom <see cref="IModuleManagerFactory"/>.
  /// </para>
  /// </remarks>
      ...
      : ThreadSafeSingletonBase<IConcreteTypeBuilder, ServiceLocatorInstanceCreator<IConcreteTypeBuilder>>, IConcreteTypeBuilder
  {
    ...
    private readonly IModuleManagerFactory _moduleManagerFactory;
    ...
    public ConcreteTypeBuilder (
        IModuleManagerFactory moduleManagerFactory,
        IConcreteMixedTypeNameProvider mixedTypeNameProvider,
        IConcreteMixinTypeNameProvider mixinTypeNameProvider)
    {
      ArgumentUtility.CheckNotNull ("moduleManagerFactory", moduleManagerFactory);
      ...
      _moduleManagerFactory = moduleManagerFactory;
    ...
    /// <summary>
    /// Gets the factory used to create the <see cref="Scope"/>.
    /// </summary>
    /// <value>The <see cref="IModuleManagerFactory"/>.</value>
    public IModuleManagerFactory ModuleManagerFactory
    {
      get { return _moduleManagerFactory; }
    }
    ...
    /// not guaranteed to be thread-safe. To configure the <see cref="Scope"/>, it's recommended to pass in a custom 
    /// <see cref="IModuleManagerFactory"/> to the 
    /// <see cref="ConcreteTypeBuilder(IModuleManagerFactory, IConcreteMixedTypeNameProvider, IConcreteMixinTypeNameProvider)"/> constructor.
    /// </summary>
    ...
    public IModuleManager Scope
    {
      get
      {
        ...
        {
          if (_scope == null)
            _scope = _moduleManagerFactory.Create();
          return _scope;
        }
      }
      set
    ...
    /// The names of the assemblies used by this method depend on the <see cref="Scope"/>. It is recommended to use a custom 
    /// <see cref="IModuleManagerFactory"/> in order to configure the <see cref="Scope"/>'s properties.
    /// </summary>
