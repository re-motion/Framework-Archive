...
namespace Remotion.Mixins.CodeGeneration
{
  ...
  public interface IConcreteTypeBuilder
  {
    ...
    /// <summary>
    /// Resets the dynamic scope of this builder. All code generated by this <see cref="ConcreteTypeBuilder"/> will subsequently be
    /// created within a new scope (i.e., usually, a new in-memory assembly).
    /// </summary>
    /// <remarks>
    /// <para>
    /// Having different assemblies with the same names loaded into one AppDomain can lead to sporadic
