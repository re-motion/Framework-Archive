...
{
  /// <summary>
  /// Retrieves extensible enum values by discovering and invoking the extension methods defining those values via reflection.
  /// </summary>
  public class ExtensibleEnumValueDiscoveryServiceImplementation
  {
