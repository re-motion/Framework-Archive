<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditConcreteConcretePositionControl.ascx.cs" Inherits="Rubicon.SecurityManager.Client.Web.OrganizationalStructure.UI.EditConcretePositionControl" %>
