<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchGroupTypeControl.ascx.cs" Inherits="Rubicon.SecurityManager.Client.Web.OrganizationalStructure.UI.SearchGroupTypeControl" %>
