<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditPositionControl.ascx.cs" Inherits="Rubicon.SecurityManager.Client.Web.UI.OrganizationalStructure.EditPositionControl" %>
