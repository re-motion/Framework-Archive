<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PositionListControl.ascx.cs" Inherits="Rubicon.SecurityManager.Client.Web.UI.OrganizationalStructure.PositionListControl" %>
