<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditRoleControl.ascx.cs" Inherits="Rubicon.SecurityManager.Client.Web.UI.OrganizationalStructure.EditRoleControl" %>
