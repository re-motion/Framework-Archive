<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GroupTypeListControl.ascx.cs" Inherits="Rubicon.SecurityManager.Client.Web.UI.OrganizationalStructure.GroupTypeListControl" %>
