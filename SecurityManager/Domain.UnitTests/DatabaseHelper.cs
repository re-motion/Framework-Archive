...
namespace Rubicon.SecurityManager.Domain.UnitTests
{
  public class DatabaseHelper
  {
    ...
    {
      RdbmsProviderDefinition providerDefinition = (RdbmsProviderDefinition) StorageProviderConfiguration.Current.StorageProviderDefinitions["SecurityManagerDomain"];
