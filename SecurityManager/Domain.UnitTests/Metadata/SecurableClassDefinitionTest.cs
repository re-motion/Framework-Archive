...
using Rubicon.SecurityManager.Domain.UnitTests.AccessControl;
...
namespace Rubicon.SecurityManager.Domain.UnitTests.Metadata
{
  ...
  public class SecurableClassDefinitionTest : DomainTest
  {
    ...
    public void FindByName_ValidClassName ()
    {
      ...
      SecurableClassDefinition foundClass = SecurableClassDefinition.FindByName (transaction, "Rubicon.SecurityManager.Domain.UnitTests.TestDomain.Invoice");
