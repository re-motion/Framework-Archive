...
{
  [TestFixture]
  public class SearchOtherProperty : GroupPropertyTypeSearchServiceTestBase
  {
    ...
    [ExpectedException (typeof (ArgumentException), ExpectedMessage =
        ...
        + "'Remotion.SecurityManager.Domain.OrganizationalStructure.GroupPropertyTypeSearchService' type.",
