...
{
  [TestFixture]
  public class AceForOwningGroupAndChildren : SecurityTokenMatcherTestBase
  {
    ...
    public override void SetUp ()
    {
      ...
      Assert.That (_ace.GroupHierarchyCondition, Is.EqualTo (GroupHierarchyCondition.ThisAndChildren));
