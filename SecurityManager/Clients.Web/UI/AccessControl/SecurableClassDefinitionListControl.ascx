<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SecurableClassDefinitionListControl.ascx.cs" Inherits="Rubicon.SecurityManager.Clients.Web.UI.AccessControl.SecurableClassDefinitionListControl" %>
