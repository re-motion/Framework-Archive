...
namespace Rubicon.ObjectBinding.UnitTests.BindableObject
{
  ...
  public class PropertyBaseTest : TestBase
  {
    ...
    public void GetListInfo ()
    {
      ...
      PropertyBase propertyBase = new NotSupportedProperty (GetPropertyInfo (typeof (ClassWithAllDataTypes), "Object"), expected, false);
    ...
    {
      PropertyBase propertyBase = new NotSupportedProperty (GetPropertyInfo (typeof (ClassWithAllDataTypes), "Object"), null, false);
    ...
    {
      PropertyBase property = new StubPropertyBase (GetPropertyInfo (typeof (ClassWithAllDataTypes), "Object"), null, false);
    ...
    public void ConvertFromNativePropertyType_Array ()
    {
      PropertyBase property =
          new StubPropertyBase (GetPropertyInfo (typeof (ClassWithAllDataTypes), "ObjectArray"), new ListInfo (typeof (UnboundClass)), false);
    ...
    {
      PropertyBase property =
          new StubPropertyBase (GetPropertyInfo (typeof (ClassWithAllDataTypes), "ObjectArrayList"), new ListInfo (typeof (UnboundClass)), false);
    ...
    {
      PropertyBase property =
          new StubPropertyBase (GetPropertyInfo (typeof (ClassWithAllDataTypes), "ListOfObject"), new ListInfo (typeof (UnboundClass)), false);
