...
public class BocMenuItem: MenuItem
{
  public BocMenuItem (
    ...
    : base (id, category, text, icon, iconDisabled, requiredSelection, isDisabled, command)
  {
  }

  public BocMenuItem ()
    : this (null, null, null, null, null, RequiredSelection.Any, false, new BocMenuItemCommand())
  {
  }
