...
public abstract class BocColumnDefinition
{
  ...
  private Unit _width; 
  /// <summary> The <see cref="BocColumnCommand"/> rendered in this column. </summary>
  private BocColumnCommand _command;
  /// <summary>
  ...
  ///   title, a width, and the <see cref="BocColumnCommand"/>.
  /// </summary>
  /// <param name="columnTitle"> The text displayed in the title row. </param>
  /// <param name="width"> The width of the rendered column. </param>
  /// <param name="command"> The <see cref="BocColumnCommand"/> rendered in this column. </param>
  public BocColumnDefinition (string columnTitle, Unit width, BocColumnCommand command)
  {
  ...
  public BocColumnDefinition (string columnTitle, Unit width)
    : this (columnTitle, width, new BocColumnCommand())
  {
  }
  ...
  /// <summary> Gets or sets the <see cref="BocColumnCommand"/> rendered in this column. </summary>
  /// <value> A <see cref="BocColumnCommand"/>. </value>
  [PersistenceMode (PersistenceMode.InnerProperty)]
  [DesignerSerializationVisibility (DesignerSerializationVisibility.Content)]
  [Category ("Action")]
  [Description ("The command rendered in this column.")]
  [NotifyParentProperty (true)]
  public BocColumnCommand Command
  {
    get { return _command; }
    set 
    { 
...
/// <summary> A column definition containing no data, only the <see cref="BocColumnCommand"/>. </summary>
public class BocCommandColumnDefinition: BocColumnDefinition
{
  ...
  ///   title, a width, a <see cref="BocColumnCommand"/>, and the label and icon representing 
...
public abstract class BocValueColumnDefinition: BocColumnDefinition
{
  ...
  /// <param name="width"> The width of the rendered column. </param>
  /// <param name="command"> The <see cref="BocColumnCommand"/> rendered in this column. </param>
  public BocValueColumnDefinition (string columnTitle, Unit width, BocColumnCommand command)
    : base (columnTitle, width, command)
  {
  }
...
public class BocSimpleColumnDefinition: BocValueColumnDefinition, IReferencePropertySource
{
  ...
  ///   title, a width, a <see cref="BocColumnCommand"/>, a format string describing how the
