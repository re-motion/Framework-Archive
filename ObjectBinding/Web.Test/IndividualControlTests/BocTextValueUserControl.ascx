...
<table id=FormGrid runat="server">
  ...
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=FirstNameField runat="server" Width="150px" PropertyIdentifier="FirstName" required="True" datasourcecontrol="CurrentObject"></rubicon:boctextvalue></td>
    <td>
  ...
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=ReadOnlyFirstNameField runat="server" Width="150px" datasourcecontrol="CurrentObject" PropertyIdentifier="FirstName" ReadOnly="True"></rubicon:boctextvalue></td>
    <td>
  ...
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=UnboundFirstNameField runat="server" Width="150px"></rubicon:boctextvalue></td>
    <td>
  ...
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=UnboundReadOnlyFirstNameField runat="server" Width="150px" ReadOnly="True"></rubicon:boctextvalue></td>
    <td>
  ...
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=IncomeField runat="server" Width="150px" datasourcecontrol="CurrentObject" PropertyIdentifier="Income" ReadOnly="True" format="c"></rubicon:boctextvalue></td>
    <td>
      <p>&nbsp;</p></td>
...
<textboxstyle maxlength="3">
  ...
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=DateOfBirthField runat="server" Width="150px" datasourcecontrol="CurrentObject" PropertyIdentifier="DateOfBirth"></rubicon:boctextvalue></td>
    <td>
      <p>&nbsp;</p></td>
    <td style="WIDTH: 20%"><asp:label id=Label2 runat="server" enableviewstate="False">#</asp:label></td></tr>
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=DateOfDeathField runat="server" Width="150px" datasourcecontrol="CurrentObject" PropertyIdentifier="DateOfDeath"></rubicon:boctextvalue></td>
    <td>
      <p>&nbsp;</p></td>
    <td style="WIDTH: 20%"><asp:label id=Label3 runat="server" enableviewstate="False">#</asp:label></td></tr>
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id=DisabledFirstNameField runat="server" Width="150px" datasourcecontrol="CurrentObject" PropertyIdentifier="FirstName" enabled="false"></rubicon:boctextvalue></td>
    <td>
  ...
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id="BocTextValue1" runat="server" ValueType="Integer" required="True" numberstyle="AllowThousands"></rubicon:boctextvalue></td>
    <td></td>
    <td style="WIDTH: 20%"></td></tr>
  <tr>
    <td></td>
    <td><rubicon:boctextvalue id="BocTextValue2" runat="server" ValueType="Double"></rubicon:boctextvalue></td>
    <td></td>
