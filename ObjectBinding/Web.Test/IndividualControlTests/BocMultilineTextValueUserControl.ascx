...
<rubicon:formgridmanager id=FormGridManager runat="server"/><rubicon:BindableObjectDataSourceControl id=CurrentObject runat="server" typename="OBRTest.Person, OBRTest"/></div>
      <table id=FormGrid runat="server">
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=CVField runat="server" datasourcecontrol="CurrentObject" PropertyIdentifier="CV" requirederrormessage="Eingabe erforderlich" Width="150px" required="True">
<textboxstyle rows="3" textmode="MultiLine" autopostback="True" maxlength="50">
</TextBoxStyle>
            </obw:bocmultilinetextvalue></td>
          <td>
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=ReadOnlyCVField runat="server" ReadOnly="True" datasourcecontrol="CurrentObject" PropertyIdentifier="CV" Width="150px">
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=UnboundCVField runat="server" Width="150px">
<textboxstyle rows="3" textmode="MultiLine">
</TextBoxStyle></obw:bocmultilinetextvalue></td>
          <td>
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=UnboundReadOnlyCVField runat="server" ReadOnly="True" Width="150px">
              <textboxstyle rows="5" textmode="MultiLine">
              </textboxstyle></obw:bocmultilinetextvalue></td>
          <td>
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=DisabledCVField runat="server" datasourcecontrol="CurrentObject" PropertyIdentifier="CV" requirederrormessage="Eingabe erforderlich" Width="150px" required="True" enabled=false>
<textboxstyle rows="3" textmode="MultiLine">
</TextBoxStyle>
            </obw:bocmultilinetextvalue></td>
          <td>
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=DisabledReadOnlyCVField runat="server" ReadOnly="True" datasourcecontrol="CurrentObject" PropertyIdentifier="CV" Width="150px" enabled=false>
              <textboxstyle rows="5" textmode="MultiLine">
              </textboxstyle>
            </obw:bocmultilinetextvalue></td>
          <td>
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=DisabledUnboundCVField runat="server" Width="150px" enabled=false>
<textboxstyle rows="3" textmode="MultiLine">
</TextBoxStyle></obw:bocmultilinetextvalue></td>
          <td>
        ...
        <tr>
          <td></td>
          <td><obw:bocmultilinetextvalue id=DisabledUnboundReadOnlyCVField runat="server" ReadOnly="True" Width="150px" enabled=false>
              <textboxstyle rows="5" textmode="MultiLine">
              </textboxstyle></obw:bocmultilinetextvalue></td>
          <td>
