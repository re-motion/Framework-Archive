...
<p><asp:button id=ChildrenListEndEditModeButton runat="server" Text="Close Edit Mode"></asp:button><asp:button id=ChildrenListAddAndEditButton runat="server" Text="Add and Edit"></asp:button></p>
