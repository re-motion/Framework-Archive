...
<table id="FormGrid" runat="server">
  ...
  <tr>
    <td></td>
    <td><rubicon:boccheckbox id="DeceasedField" runat="server" datasourcecontrol="CurrentObject" truedescription="ja" falsedescription="nein" width="300px" propertyidentifier="Deceased" showdescription="True" AutoPostBack="True" ></rubicon:boccheckbox></td>
  ...
  <tr>
    <td></td>
    <td><rubicon:boccheckbox id="UnboundDeceasedField" runat="server" Width="150px" AutoPostBack="True" ShowDescription="False"></rubicon:boccheckbox></td>
  ...
  <tr>
    <td></td>
    <td><rubicon:boccheckbox id="DisabledDeceasedField" runat="server" datasourcecontrol="CurrentObject" truedescription="ja" falsedescription="nein" width="300px" propertyidentifier="Deceased" showdescription="True" enabled="false"></rubicon:boccheckbox></td>
