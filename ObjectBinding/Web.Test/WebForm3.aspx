...
<%@ Register TagPrefix="cc1" Namespace="Rubicon.ObjectBinding.Web.UI.Controls" Assembly="Rubicon.ObjectBinding.Web" %>
...
<HTML>
  ...
  <body MS_POSITIONING="GridLayout">
    <form id="Form1" method="post" runat="server">
      ...
      <rwc:SmartLabel id="BocPropertyLabel1" style="Z-INDEX: 102; LEFT: 48px; POSITION: absolute; TOP: 48px"
      ...
      <rwc:SmartLabel id="BocPropertyLabel2" style="Z-INDEX: 105; LEFT: 48px; POSITION: absolute; TOP: 88px"
        runat="server" ForControl="HeightField"></rwc:SmartLabel>
