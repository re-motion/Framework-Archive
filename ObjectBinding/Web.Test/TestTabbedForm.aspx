...
<style>SepDefaultStyle {
	BORDER-BOTTOM: #000000 1px solid
}
TabHoverStyle {
	BACKGROUND-COLOR: #e0e0e0; TEXT-DECORATION: underline
}
TabSelectedStyle {
	COLOR: #000000; BORDER-BOTTOM: medium none; BACKGROUND-COLOR: #ffffff
}
TabDefaultStyle {
	BORDER-RIGHT: #000000 2px solid; BORDER-TOP: #000000 1px solid; FONT-WEIGHT: bold; FONT-SIZE: 0.8em; BORDER-LEFT: #000000 1px solid; WIDTH: 10em; COLOR: #000000; BORDER-BOTTOM: #000000 1px solid; FONT-FAMILY: verdana,arial; HEIGHT: 1.6em; BACKGROUND-COLOR: #e0e0e0; TEXT-ALIGN: center
}
</style>
</head>
<body>
...
<div><rwc:webtabstrip id=PagesTabStrip runat="server" AutoPostBack="True" TargetID="PagesMultiPage" width="100%"></rwc:webtabstrip>
<table 
