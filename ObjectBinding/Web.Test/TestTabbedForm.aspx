...
<rwc:validationstateviewer id="ValidationStateViewer" runat="server" visible="true" DESIGNTIMEDRAGDROP="119"></rwc:validationstateviewer>
<div><rwc:tabstrip id=PagesTabStrip runat="server" width="100%" TargetID="PagesMultiPage" Orientation="horizontal" SepDefaultStyle="border-bottom:1px solid #000000;  " TabHoverStyle="text-decoration: underline;  background-color:#E0E0E0; " TabSelectedStyle="border-bottom:none;  background-color:#ffffff; color:#000000" TabDefaultStyle="width:10em; height:1.6em; border-left:1px solid #000000; border-right:2px solid #000000; border-top:1px solid #000000; border-bottom:1px solid #000000; background-color:#E0E0E0; font-family:verdana,arial; font-weight:bold; font-size:.8em; color:#000000; text-align:center; " AutoPostBack="True"></rwc:tabstrip>
<table 
