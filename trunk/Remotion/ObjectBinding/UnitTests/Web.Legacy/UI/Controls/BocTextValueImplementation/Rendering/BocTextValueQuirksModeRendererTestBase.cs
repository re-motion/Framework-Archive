...
{
  public class BocTextValueQuirksModeRendererTestBase<T> : RendererTestBase
      where T: class, IBocTextValueBase
  {
    ...
    protected void CheckCssClass (BocTextValueQuirksModeRendererBase<T> renderer, XmlNode span, bool withCssClass, bool inStandardProperties)
    {
