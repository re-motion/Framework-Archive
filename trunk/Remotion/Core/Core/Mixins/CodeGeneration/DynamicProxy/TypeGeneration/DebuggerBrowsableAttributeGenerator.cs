...
{
  /// <summary>
  /// Generates the <see cref="DebuggerBrowsableAttribute"/> on the given emitted members, this hiding them from the debugger.
  /// </summary>
  public class DebuggerBrowsableAttributeGenerator
  {
