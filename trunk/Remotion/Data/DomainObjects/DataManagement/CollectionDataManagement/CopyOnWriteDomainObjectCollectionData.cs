...
namespace Remotion.Data.DomainObjects.DataManagement.CollectionDataManagement
{
  ...
  /// </remarks>
  [Serializable]
  public class CopyOnWriteDomainObjectCollectionData : ObservableCollectionDataDecoratorBase
  {
    private readonly ObservableCollectionDataDecorator _copiedData;

    public CopyOnWriteDomainObjectCollectionData (ObservableCollectionDataDecorator copiedData)
