...
{
  [TestFixture]
  public class CreateSubTransactionTest : InactiveTransactionsTestBase
  {
    [Test]
    public void CreateSubTransactionInInactiveRootTransaction_IsForbidden ()
    {
      ...
      CheckForbidden (() => InactiveRootTransaction.CreateSubTransaction (), "SubTransactionCreating");
    ...
    public void CreateSubTransactionInInactiveMiddleTransaction_IsForbidden ()
    {
      ...
      CheckForbidden (() => InactiveMiddleTransaction.CreateSubTransaction (), "SubTransactionCreating");
