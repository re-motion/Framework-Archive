...
namespace Remotion.Mixins.CodeGeneration.DynamicProxy
{
  ...
  public class CodeGenerationMixinContextOriginSerializer : IMixinContextOriginSerializer
  {
    ...
    public void AddKind (string kind)
    {
      ...
      _constructorArguments[0] = new ConstReference (kind).ToExpression();
    }
    ...
    public void AddAssembly (Assembly assembly)
    {
      ...
      _constructorArguments[1] = new MethodInvocationExpression (null, s_assemblyLoadMethod, new ConstReference (assembly.FullName).ToExpression());
    }

    public void AddLocation (string location)
    {
      _constructorArguments[2] = new ConstReference (location).ToExpression ();
    }
  }
}
