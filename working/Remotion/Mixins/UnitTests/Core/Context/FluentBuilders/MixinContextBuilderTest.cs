  ...
  public class MixinContextBuilderTest
  {
    ...
    public void ParentMembers ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        ...
        _parentBuilderMock.Expect (mock => mock.AddCompleteInterface (typeof (IBT6Mixin1))).Return (r1);
        _parentBuilderMock.Expect (mock => mock.AddCompleteInterface<IBT6Mixin1>()).Return (r1);
        _parentBuilderMock.Expect (mock => mock.AddCompleteInterfaces (typeof (IBT6Mixin1), typeof (IBT6Mixin2))).Return (r1);
        _parentBuilderMock.Expect (mock => mock.AddCompleteInterfaces<IBT6Mixin1, IBT6Mixin2> ()).Return (r1);
        _parentBuilderMock.Expect (mock => mock.AddCompleteInterfaces<IBT6Mixin1, IBT6Mixin2, IBT6Mixin3> ()).Return (r1);
        _parentBuilderMock.Expect (mock => mock.AddCompleteInterfaces<IBT6Mixin1, IBT6Mixin2, IBT6Mixin3> ()).Return (r1);
      ...
      Assert.That (_mixinBuilder.AddCompleteInterface (typeof (IBT6Mixin1)), Is.SameAs (r1));
      Assert.That (_mixinBuilder.AddCompleteInterface<IBT6Mixin1> (), Is.SameAs (r1));
      Assert.That (_mixinBuilder.AddCompleteInterfaces (typeof (IBT6Mixin1), typeof (IBT6Mixin2)), Is.SameAs (r1));
      Assert.That (_mixinBuilder.AddCompleteInterfaces<IBT6Mixin1, IBT6Mixin2> (), Is.SameAs (r1));
      Assert.That (_mixinBuilder.AddCompleteInterfaces<IBT6Mixin1, IBT6Mixin2, IBT6Mixin3> (), Is.SameAs (r1));
      Assert.That (_mixinBuilder.AddCompleteInterfaces<IBT6Mixin1, IBT6Mixin2, IBT6Mixin3> (), Is.SameAs (r1));
