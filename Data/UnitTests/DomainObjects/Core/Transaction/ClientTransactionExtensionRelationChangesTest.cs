...
namespace Remotion.Data.UnitTests.DomainObjects.Core.Transaction
{
  ...
  public class ClientTransactionExtensionRelationChangesTest : ClientTransactionBaseTest
  {
    ...
    public void OneToOneRelationFromVirtualEndPointWithNewNull ()
    {
      using (_mockRepository.Ordered ())
      {
        _extension.RelationChanging (ClientTransactionMock,
          _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket", _orderTicket1, null);
        _extension.RelationChanging (ClientTransactionMock, _orderTicket1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderTicket.Order", _order1, null);
        ...
        _orderTicket1EventReceiver.RelationChanging (_orderTicket1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderTicket.Order", _order1, null);
    ...
    public void OneToOneRelationFromVirtualEndPointWithBothOldRelatedObjects ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        _extension.RelationChanging (ClientTransactionMock, orderTicket3, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderTicket.Order", oldOrderOfOrderTicket3, _order1);
        _extension.RelationChanging (ClientTransactionMock, oldOrderOfOrderTicket3, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket", orderTicket3, null);
        _extension.RelationChanging (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket", _orderTicket1, orderTicket3);
        _extension.RelationChanging (ClientTransactionMock, _orderTicket1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderTicket.Order", _order1, null);

        orderTicket3EventReceiver.RelationChanging (orderTicket3, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderTicket.Order", oldOrderOfOrderTicket3, _order1);

        oldOrderOfOrderTicket3EventReceiver.RelationChanging (oldOrderOfOrderTicket3, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket", orderTicket3, null);

        _order1EventReceiver.RelationChanging (_order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket", _orderTicket1, orderTicket3);
        ...
        _extension.RelationChanged (ClientTransactionMock, oldOrderOfOrderTicket3, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket");
        _extension.RelationChanged (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket");
        _extension.RelationChanged (ClientTransactionMock, _orderTicket1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderTicket.Order");
        ...
        oldOrderOfOrderTicket3EventReceiver.RelationChanged (oldOrderOfOrderTicket3, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderTicket");
    ...
    public void UnidirectionalRelationWithNewNull ()
    {
      using (_mockRepository.Ordered ())
      {
        _extension.RelationChanging (ClientTransactionMock, _location1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Location.Client", _client1, null);
    ...
    public void UnidirectionalRelationWithOldNull ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        _extension.RelationChanging (ClientTransactionMock, newLocation, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Location.Client", null, _client1);
    ...
    public void UnidirectionalRelationWithOldRelatedObject ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        _extension.RelationChanging (ClientTransactionMock, _location1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Location.Client", _client1, newClient);
    ...
    public void RemoveFromOneToManyRelation ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        _extension.RelationReading (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", ValueAccess.Current);
        ...
        _extension.RelationChanging (ClientTransactionMock, orderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderItem.Order", _order1, null);
        _extension.RelationChanging (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", orderItem, null);
    ...
    public void AddToOneToManyRelation ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        ...
        _extension.RelationChanging (ClientTransactionMock, orderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderItem.Order", null, _order1);
        _extension.RelationChanging (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", null, orderItem);
    ...
    public void AddToOneToManyRelationWithOldRelatedObject ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        ...
        _extension.RelationChanging (ClientTransactionMock, newOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderItem.Order", oldOrderOfNewOrderItem, _order1);
        _extension.RelationChanging (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", null, newOrderItem);
        _extension.RelationChanging (ClientTransactionMock, oldOrderOfNewOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", newOrderItem, null);

        newOrderItemEventReceiver.RelationChanging (newOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderItem.Order", oldOrderOfNewOrderItem, _order1);
        ...
        oldOrderOfNewOrderItemEventReceiver.RelationChanging (oldOrderOfNewOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", newOrderItem, null);
        ...
        _extension.RelationChanged (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems");
        _extension.RelationChanged (ClientTransactionMock, oldOrderOfNewOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems");

        newOrderItemEventReceiver.RelationChanged (newOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderItem.Order");

        _order1EventReceiver.RelationChanged (_order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems");

        oldOrderOfNewOrderItemEventReceiver.RelationChanged (oldOrderOfNewOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems");
      }
    ...
    public void ReplaceInOneToManyRelation ()
    {
      ...
      using (_mockRepository.Ordered ())
      {
        ...
        _extension.RelationChanging (ClientTransactionMock, oldOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderItem.Order", _order1, null);
        _extension.RelationChanging (ClientTransactionMock, newOrderItem, "Remotion.Data.UnitTests.DomainObjects.TestDomain.OrderItem.Order", null, _order1);
        _extension.RelationChanging (ClientTransactionMock, _order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", oldOrderItem, newOrderItem);
        ...
        _order1EventReceiver.RelationChanging (_order1, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Order.OrderItems", oldOrderItem, newOrderItem);
