...
namespace Remotion.Data.UnitTests.DomainObjects.Core.DomainObjects
{
  ...
  public class PropertyAccessorTest : ClientTransactionBaseTest
  {
    ...
    public void PropertyAccessorKindInstance ()
    {
      IndustrialSector sector = IndustrialSector.NewObject();
      Assert.AreEqual (PropertyKind.PropertyValue,
          CreateAccessor (sector, "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Name").Kind, "Property value type");

      Assert.AreEqual (PropertyKind.RelatedObjectCollection,
          CreateAccessor (sector, "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Companies").Kind,
          "Related object collection type - bidirectional relation 1:n, 1 side");

      Company company = Company.NewObject ();
      Assert.AreEqual (PropertyKind.RelatedObject,
          CreateAccessor (company, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Company.IndustrialSector").Kind,
          "Related object type - bidirectional relation 1:n, n side");

      Employee employee = Employee.NewObject ();
      Assert.AreEqual (PropertyKind.RelatedObject,
          CreateAccessor (employee, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Employee.Computer").Kind,
          "Related object type - bidirectional relation 1:1, referenced side");

      Computer computer = Computer.NewObject ();
      Assert.AreEqual (PropertyKind.RelatedObject,
          CreateAccessor (computer, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Computer.Employee").Kind,
          "Related object type - bidirectional relation 1:1, foreign key side");

      Client client = Client.NewObject ();
      Assert.AreEqual (PropertyKind.RelatedObject,
          CreateAccessor (client, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Client.ParentClient").Kind,
          "Related object type - unidirectional relation 1:n, 1 side");
    }
    ...
    {
      Assert.AreEqual (typeof (string),
          CreateAccessor (IndustrialSector.NewObject(), "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Name").PropertyType,
          "Property value type");

      Assert.AreEqual (typeof (ObjectList<Company>),
          CreateAccessor (IndustrialSector.NewObject (), "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Companies").PropertyType,
          "Related object collection type - bidirectional relation 1:n, 1 side");

      Assert.AreEqual (typeof (IndustrialSector),
          CreateAccessor (Company.NewObject (), "Remotion.Data.UnitTests.DomainObjects.TestDomain.Company.IndustrialSector").PropertyType,
          "Related object type - bidirectional relation 1:n, n side");

      Assert.AreEqual (typeof (Computer),
          CreateAccessor (Employee.NewObject(), "Remotion.Data.UnitTests.DomainObjects.TestDomain.Employee.Computer").PropertyType,
          "Related object type - bidirectional relation 1:1, referenced side");

      Assert.AreEqual (typeof (Employee),
          CreateAccessor (Computer.NewObject (),  "Remotion.Data.UnitTests.DomainObjects.TestDomain.Computer.Employee").PropertyType,
          "Related object type - bidirectional relation 1:1, foreign key side");

      Assert.AreEqual (typeof (Client),
          CreateAccessor (Client.NewObject (),  "Remotion.Data.UnitTests.DomainObjects.TestDomain.Client.ParentClient").PropertyType,
          "Related object type - unidirectional relation 1:n, 1 side");
    }
    ...
    {
      IndustrialSector sector = IndustrialSector.NewObject ();
      CreateAccessor (sector, "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Name").GetValue<int>();
    }
    ...
    {
      IndustrialSector sector = IndustrialSector.NewObject ();
      CreateAccessor (sector, "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Name").SetValue (5);
    }
    ...
    public void PropertyMetadata()
    {
      ...
      Assert.AreSame ("Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Companies", accessor.PropertyIdentifier);
    ...
    {
      IndustrialSector sector = IndustrialSector.GetObject (DomainObjectIDs.IndustrialSector1);
      PropertyAccessor property = CreateAccessor (sector, "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Name");
    ...
    public void HasChangedAndOriginalValueRelated()
    {
      ...
      PropertyAccessor property = CreateAccessor (computer, "Remotion.Data.UnitTests.DomainObjects.TestDomain.Computer.Employee");
      Assert.IsFalse (property.HasChanged);
    ...
    {
      IndustrialSector sector = IndustrialSector.GetObject (DomainObjectIDs.IndustrialSector1);
      PropertyAccessor property = CreateAccessor (sector, "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Companies");
    ...
    {
      CreateAccessor (IndustrialSector.NewObject(), "Remotion.Data.UnitTests.DomainObjects.TestDomain.IndustrialSector.Companies")
