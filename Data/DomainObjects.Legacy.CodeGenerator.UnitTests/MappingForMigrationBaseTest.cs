...
{
  public class MappingForMigrationBaseTest
  {
    // types
    ...
    public MappingForMigrationBaseTest()
    {
    }
    ...
    {
      _mappingConfiguration = XmlBasedMappingConfiguration.Create ("MappingForMigrationTests.xml", false);
