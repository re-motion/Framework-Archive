...
using Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.MixinTestDomain;
...
namespace Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.ClassReflectorTests
{
  ...
  public class GetClassDefinition : TestBase
  {
    ...
    [ExpectedException (typeof (MappingException), ExpectedMessage =
        ...
        + "'Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain.Errors.BaseClassWithStorageGroupAttribute'.\r\n"
        + "Type: Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain.Errors.Derived2ClassWithStorageGroupAttribute")]
    ...
    [ExpectedException (typeof (MappingException), ExpectedMessage =
        ...
        + "Type: Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain.Errors.ClassWithLegacyLoadConstructor")]
    ...
    [ExpectedException (typeof (MappingException), ExpectedMessage =
        ...
        + "Type: Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain.Errors.GenericClass`1")]
    ...
    [Test]
    [ExpectedException (typeof (MappingException), ExpectedMessage = "Class 'Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping."
        + "TestDomain.Errors.ClassWithSameClassID' and 'Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain.Errors."
        + "OtherClassWithSameClassID' both have the same class ID 'DefinedID'. Use the ClassIDAttribute to define unique IDs for these "
        + "classes. The assemblies involved are 'Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain.Errors, "
        + "Version=0.0.0.0, Culture=neutral, PublicKeyToken=null' and 'Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain."
    ...
    private static Type GetTypeFromDomainWithErrors (string typename)
    {
      Type type = TestDomainFactory.ConfigurationMappingTestDomainErrors.GetType (
          "Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Mapping.TestDomain.Errors." + typename,
          true,
          false);
