...
namespace Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.Queries
{
  ...
  public class QueryConfigurationTest : StandardMappingTest
  {
    ...
    public void Loading ()
    {
      QueryConfigurationLoader loader = new QueryConfigurationLoader (@"DomainObjects\\QueriesForLoaderTest.xml");
    ...
    {
      QueryConfigurationLoader loader = new QueryConfigurationLoader (@"DomainObjects\\ScalarQueryWithCollectionType.xml");
    ...
    {
      string configurationFile = "DomainObjects\\QueriesWithInvalidNamespace.xml";
      try
      {
    ...
    {
      QueryConfiguration configuration = new QueryConfiguration ("DomainObjects\\QueriesForLoaderTest.xml");
    ...
    {
      QueryConfiguration configuration = new QueryConfiguration ("DomainObjects\\QueriesForLoaderTest.xml", "DomainObjects\\QueriesForLoaderTest2.xml");

      QueryConfigurationLoader loader1 = new QueryConfigurationLoader (@"DomainObjects\\QueriesForLoaderTest.xml");
      QueryConfigurationLoader loader2 = new QueryConfigurationLoader (@"DomainObjects\\QueriesForLoaderTest2.xml");
    ...
    {
      QueryConfiguration configuration = new QueryConfiguration ("DomainObjects\\QueriesForLoaderTest.xml", "DomainObjects\\QueriesForLoaderTestDuplicate.xml");
