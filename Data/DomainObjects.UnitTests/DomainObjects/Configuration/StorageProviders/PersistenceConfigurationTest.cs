...
namespace Remotion.Data.DomainObjects.UnitTests.DomainObjects.Configuration.StorageProviders
{
  [TestFixture]
  public class PersistenceConfigurationTest
  {
    ...
    public void Deserialize_WithStorageGroups()
    {
      string xmlFragment =
          @"<storage defaultProviderDefinition=""Rdbms"">
            <groups>
              <add type=""Remotion.Data.DomainObjects.UnitTests::DomainObjects.Configuration.StorageProviders.StubStorageGroup1Attribute"" 
                  provider=""Rdbms""/>
              <add type=""Remotion.Data.DomainObjects.UnitTests::DomainObjects.Configuration.StorageProviders.StubStorageGroup2Attribute"" 
                  provider=""Rdbms""/>
            </groups>
            <providerDefinitions>
              <add type=""Remotion.Data.DomainObjects::Persistence.Rdbms.RdbmsProviderDefinition"" 
