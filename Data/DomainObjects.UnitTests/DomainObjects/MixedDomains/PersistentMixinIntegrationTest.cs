...
namespace Remotion.Data.DomainObjects.UnitTests.DomainObjects.MixedDomains
{
  ...
  public class PersistentMixinIntegrationTest : ClientTransactionBaseTest
  {
    ...
    [ExpectedException (typeof (MappingException), ExpectedMessage = "A persistence-related mixin was removed from the domain object type "
       + "Remotion.Data.DomainObjects.UnitTests.DomainObjects.MixedDomains.SampleTypes.StubStorageTargetClassForPersistentMixin after the mapping information was built: "
       + "Remotion.Data.DomainObjects.UnitTests.DomainObjects.MixedDomains.SampleTypes.StubStoragePersistentMixin.")]
