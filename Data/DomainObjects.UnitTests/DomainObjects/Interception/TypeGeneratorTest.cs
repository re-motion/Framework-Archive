...
using Remotion.Data.DomainObjects.UnitTests.DomainObjects.Interception.SampleTypes;
...
namespace Remotion.Data.DomainObjects.UnitTests.DomainObjects.Interception
{
  [TestFixture]
  public class TypeGeneratorTest : ClientTransactionBaseTest
  {
    ...
    [ExpectedException (typeof (NonInterceptableTypeException), ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests."
        + "DomainObjects.Interception.SampleTypes.NonInstantiableAbstractClassWithProps as its member get_Foo (on type NonInstantiableAbstractClassWithProps) is "
    ...
    [Test]
    [ExpectedException (typeof (NonInterceptableTypeException), ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests."
        + "DomainObjects.Interception.SampleTypes.NonInstantiableClassWithAutomaticRelatedCollectionSetter, "
        ...
        + "DomainObjects.UnitTests.DomainObjects.Interception.SampleTypes.NonInstantiableClassWithAutomaticRelatedCollectionSetter."
        + "RelatedObjects'.")]
    ...
    [Test]
    [ExpectedException (typeof (NonInterceptableTypeException), ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests."
       + "DomainObjects.Interception.SampleTypes.NonInstantiableAbstractClass as its member Foo (on type NonInstantiableAbstractClass) is abstract (and not an "
        + "automatic property).")]
    ...
    [ExpectedException (typeof (NonInterceptableTypeException),
        ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests.DomainObjects.Interception."
    ...
    [Test]
    [ExpectedException (typeof (NonInterceptableTypeException), ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests."
        + "DomainObjects.Interception.SampleTypes.NonInstantiableAbstractClassWithoutAttribute as it is abstract and not instantiable.")]
    ...
    [Test]
    [ExpectedException (typeof (NonInterceptableTypeException), ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests."
       + "DomainObjects.Interception.SampleTypes.NonInstantiableNonDomainClass as it is not part of the mapping.")]
