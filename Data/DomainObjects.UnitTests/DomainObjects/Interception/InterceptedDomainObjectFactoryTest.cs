...
namespace Remotion.Data.DomainObjects.UnitTests.DomainObjects.Interception
{
  ...
  public class InterceptedDomainObjectFactoryTest : ClientTransactionBaseTest
  {
    ...
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = "Cannot instantiate type "
       + "Remotion.Data.DomainObjects.UnitTests.DomainObjects.Interception.SampleTypes.NonInstantiableAbstractClassWithProps as its "
    ...
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = "The domain object's type "
        + "Remotion.Data.DomainObjects.UnitTests.DomainObjects.Interception.SampleTypes.DOWithConstructors was not "
