...
using Remotion.Data.DomainObjects.UnitTests.DomainObjects.Persistence.Rdbms;
  ...
  public class UnionSelectCommandBuilderTest : SqlProviderBaseTest
  {
    ...
    public override void SetUp ()
    {
      ...
      _builder = UnionSelectCommandBuilder.CreateForRelatedIDLookup (
          Provider, domainBaseClass, domainBaseClass.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.DomainObjects.TableInheritance.TestDomain.DomainBase.Client"), DomainObjectIDs.Client);
    }
    ...
    public void Create ()
    {
      ...
      domainBaseClass.MyPropertyDefinitions.Add (ReflectionBasedPropertyDefinitionFactory.CreateReflectionBasedPropertyDefinition(domainBaseClass, "Remotion.Data.DomainObjects.UnitTests.DomainObjects.TableInheritance.TestDomain.DomainBase.Client", "ClientID", typeof (ObjectID)));

      RelationEndPointDefinition domainBaseEndPointDefinition = new RelationEndPointDefinition (domainBaseClass, "Remotion.Data.DomainObjects.UnitTests.DomainObjects.TableInheritance.TestDomain.DomainBase.Client", false);
