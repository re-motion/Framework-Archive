...
namespace Rubicon.Data.DomainObjects.UnitTests.DomainObjects
{
  ...
  public class ReplaceInOneToManyRelationTest : ClientTransactionBaseTest
  {
    ...
    {
      new RelationChangeState (_oldOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", _customer, null, "1. Changing event of old order from old customer to null"),
      new RelationChangeState (_newOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", _oldCustomerOfNewOrder, _customer, "2. Changing event of new order from null to new customer"),
      ...
      new RelationChangeState (_customer, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", _oldOrder, _newOrder, "5. Changing event of customer"),
      ...
      new RelationChangeState (_oldCustomerOfNewOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", _newOrder, null, "7. Changing event of oldCustomerOfNewOrder"),

      new RelationChangeState (_oldOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "8. Changed event of old order from old customer to null"),
      new RelationChangeState (_newOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "9. Changed event of new order from null to new customer"),
      ...
      new RelationChangeState (_customer, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", null, null, "12. Changed event of customer"),
      ...
      new RelationChangeState (_oldCustomerOfNewOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", null, null, "14. Changed event of oldCustomerOfNewOrder")
    };
    ...
    {
      new RelationChangeState (_oldOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", _customer, null, "1. Changing event of old order from old customer to null"),
      new RelationChangeState (newOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, _customer, "2. Changing event of new order from null to new customer"),
      new CollectionChangeState (_customer.Orders, _oldOrder, "3. Removing event of old order from customer.Orders"),
      new CollectionChangeState (_customer.Orders, newOrder, "4. Adding event of new order to customer.Orders"),
      new RelationChangeState (_customer, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", _oldOrder, newOrder, "5. Changing event of customer"),

      new RelationChangeState (_oldOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "6. Changed event of old order from old customer to null"),
      new RelationChangeState (newOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "7. Changed event of new order from null to new customer"),
      ...
      new RelationChangeState (_customer, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", null, null, "10. Changed event of customer"),
    };
      ...
      Assert.AreEqual (StateType.New, newOrder.State);
			Assert.AreEqual (_customer.ID, newOrder.InternalDataContainer.GetValue ("Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer"));
    ...
    {
      new RelationChangeState (_oldOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", _customer, null, "1. Changing event of old order from new customer to null"),
      new RelationChangeState (newOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", oldCustomerOfNewOrder, _customer, "2. Changing event of new order from old to new customer"),
      ...
      new RelationChangeState (_customer, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", _oldOrder, newOrder, "5. Changing event of new customer from old order to new order"),

      new RelationChangeState (_oldOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "6. Changed event of old order from new customer to null"),
      new RelationChangeState (newOrder, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "7. Changed event of new order from old to new customer"),
      ...
      new RelationChangeState (_customer, "Rubicon.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", null, null, "10. Changed event of new customer from old order to new order"),
    };
