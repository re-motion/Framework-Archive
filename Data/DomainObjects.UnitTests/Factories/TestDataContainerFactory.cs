...
namespace Rubicon.Data.DomainObjects.UnitTests.Factories
{
  public class TestDataContainerFactory
  {
    ...
    public DataContainer CreateClassWithAllDataTypesDataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Rubicon.Data.DomainObjects.UnitTests.TestDomain.ClassWithAllDataTypes.StringProperty"], "abcdeföäü"));
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Rubicon.Data.DomainObjects.UnitTests.TestDomain.ClassWithAllDataTypes.NaEnumProperty"], ClassWithAllDataTypes.EnumType.Value2));
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Rubicon.Data.DomainObjects.UnitTests.TestDomain.ClassWithAllDataTypes.NaEnumWithNullValueProperty"], null));
    ...
    public DataContainer CreateDistributor2DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition.GetPropertyDefinition ("Rubicon.Data.DomainObjects.UnitTests.TestDomain.Company.Name"), "Händler 2"));
