...
namespace Rubicon.Data.DomainObjects.UnitTests.Factories
{
  public class TestDataContainerFactory
  {
    ...
    public DataContainer CreateCustomer1DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition.GetPropertyDefinition ("IndustrialSector"), _domainObjectIDs.IndustrialSector1));
    ...
    public DataContainer CreatePartner1DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition.GetPropertyDefinition ("ContactPerson"), _domainObjectIDs.Person1));
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition.GetPropertyDefinition ("IndustrialSector"), _domainObjectIDs.IndustrialSector1));
    ...
    public DataContainer CreateDistributor2DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition.GetPropertyDefinition ("ContactPerson"), _domainObjectIDs.Person6));
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition.GetPropertyDefinition ("IndustrialSector"), _domainObjectIDs.IndustrialSector1));
    ...
    public DataContainer CreateOrder1DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Official"], _domainObjectIDs.Official1));
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Customer"], _domainObjectIDs.Customer1));
    ...
    public DataContainer CreateOrder2DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Official"], _domainObjectIDs.Official1));
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Customer"], _domainObjectIDs.Customer3));
    ...
    public DataContainer CreateOrderTicket1DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Order"], _domainObjectIDs.Order1));
    ...
    public DataContainer CreateOrderTicket2DataContainer ()
    {
      ...
      dataContainer.PropertyValues.Add (new PropertyValue (classDefinition["Order"], _domainObjectIDs.OrderWithoutOrderItem));
