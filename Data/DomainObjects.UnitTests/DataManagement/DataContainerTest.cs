...
public class DataContainerTest
{
  ...
  public void GetRelationEndPoints ()
  {
    ...
    Assert.AreEqual (4, _existingDataContainer.ObjectEndPoints.Length);
    Assert.AreSame (_existingDataContainer, _existingDataContainer.ObjectEndPoints[0].DataContainer);
    Assert.AreSame (_existingDataContainer, _existingDataContainer.ObjectEndPoints[1].DataContainer);
    Assert.AreSame (_existingDataContainer, _existingDataContainer.ObjectEndPoints[2].DataContainer);
    Assert.AreSame (_existingDataContainer, _existingDataContainer.ObjectEndPoints[3].DataContainer);
    Assert.IsTrue (Array.IndexOf (expectedPropertyNames, _existingDataContainer.ObjectEndPoints[0].PropertyName) >= 0);
    Assert.IsTrue (Array.IndexOf (expectedPropertyNames, _existingDataContainer.ObjectEndPoints[1].PropertyName) >= 0);
    Assert.IsTrue (Array.IndexOf (expectedPropertyNames, _existingDataContainer.ObjectEndPoints[2].PropertyName) >= 0);
    Assert.IsTrue (Array.IndexOf (expectedPropertyNames, _existingDataContainer.ObjectEndPoints[3].PropertyName) >= 0);
  }
}
}
