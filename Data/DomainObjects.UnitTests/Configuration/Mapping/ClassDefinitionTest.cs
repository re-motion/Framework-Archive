...
public class ClassDefinitionTest
{
  ...
  public void AddDuplicateProperty ()
  {
    ...
    companyClass.PropertyDefinitions.Add (new PropertyDefinition ("Name", "Name", typeof (string), 100));
    companyClass.PropertyDefinitions.Add (new PropertyDefinition ("Name", "Name", typeof (string), 100));
  }
  ...
  public void AddDuplicatePropertyBaseClass ()
  {
    ...
    customerClass.PropertyDefinitions.Add (new PropertyDefinition ("Name", "Name", typeof (string), 100));
  }
  ...
  public void AddDuplicatePropertyBaseOfBaseClass ()
  {
    ...
    supplierClass.PropertyDefinitions.Add (new PropertyDefinition ("Name", "Name", typeof (string), 100));
  }
