...
namespace Remotion.Data.DomainObjects.UnitTests.Configuration.Mapping.RelationEndPointReflectorTests
{
  ...
  public class Common: StandardMappingTest
  {
    ...
    [ExpectedException (typeof (MappingException), ExpectedMessage = 
        ...
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidProperties, "
    ...
    private Type GetClassWithInvalidProperties ()
    {
      return TestDomainFactory.ConfigurationMappingTestDomainErrors.GetType (
          "Remotion.Data.DomainObjects.UnitTests.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidProperties", true, false);
    }
