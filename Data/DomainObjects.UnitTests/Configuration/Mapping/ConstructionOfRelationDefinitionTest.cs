...
public class ConstructionOfRelationDefinitionTest
{
  ...
  {
    ClassDefinition customerDefinition = new ClassDefinition ("Customer", "Customer", typeof (Customer), "TestDomain");
    customerDefinition.PropertyDefinitions.Add (new PropertyDefinition ("Order", "OrderID", typeof (ObjectID)));  
    ...
    orderDefinition.PropertyDefinitions.Add (new PropertyDefinition ("Customer", "CustomerID", typeof (ObjectID)));
