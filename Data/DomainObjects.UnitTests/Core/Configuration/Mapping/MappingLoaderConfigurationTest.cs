...
namespace Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping
{
  ...
  public class MappingLoaderConfigurationTest
  {
    ...
    public void Deserialize_WithCustomMappingLoader()
    {
      string xmlFragment =
          @"<mapping>
            <loader type=""Remotion.Data.DomainObjects.UnitTests::Core.Configuration.Mapping.FakeMappingLoader""/>
          </mapping>";
    ...
    public void Deserialize_WithCustomDomainObjectFactory ()
    {
      string xmlFragment =
          @"<mapping>
            <domainObjectFactory type=""Remotion.Data.DomainObjects.UnitTests::Core.Configuration.Mapping.FakeDomainObjectFactory""/>
          </mapping>";
