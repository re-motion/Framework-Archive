...
namespace Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping
{
  ...
  public class RelationReflectorTest : StandardMappingTest
  {
    ...
    [ExpectedException (typeof (MappingException),
        ...
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidUnidirectionalRelation, "
        + "property: LeftSide")]
    ...
    [ExpectedException (typeof (MappingException),
        ...
        + "'Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidBidirectionalRelationRightSide'.\r\n"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidBidirectionalRelationLeftSide, "
    ...
    [ExpectedException (typeof (MappingException),
        ...
        + "propery 'VirtualSide' declared on type 'Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors." 
        + "RelationTargetForMixinAddingBidirectionalRelationTwice'.\r\nDeclaring type: Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping." 
    ...
    [ExpectedException (typeof (MappingException),
       ...
       "The declaring type 'ClassWithInvalidBidirectionalRelationLeftSideNotInMapping' cannot be assigned to the type of the opposite relation propery 'BaseInvalidOppositePropertyTypeRightSide' declared on type "
        + "'Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidBidirectionalRelationRightSide'.\r\n"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidBidirectionalRelationLeftSideNotInMapping, "
    ...
    {
      return TestDomainFactory.ConfigurationMappingTestDomainErrors.GetType (
          "Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.ClassWithInvalidBidirectionalRelationRightSide", true, false);
    }

    private Type GetRelationTargetForMixinAddingBidirectionalRelationTwice ()
    {
      return TestDomainFactory.ConfigurationMappingTestDomainErrors.GetType (
          "Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.RelationTargetForMixinAddingBidirectionalRelationTwice", true, false);
    }

    private Type GetTargetClass1ForMixinAddingBidirectionalRelationTwice ()
    {
      return TestDomainFactory.ConfigurationMappingTestDomainErrors.GetType (
          "Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.TargetClass1ForMixinAddingBidirectionalRelationTwice", true, false);
    }

    private Type GetTargetClass2ForMixinAddingBidirectionalRelationTwice ()
    {
      return TestDomainFactory.ConfigurationMappingTestDomainErrors.GetType (
          "Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.TargetClass2ForMixinAddingBidirectionalRelationTwice", true, false);
    }

    private Type GetMixinAddingBidirectionalRelationTwice ()
    {
      return TestDomainFactory.ConfigurationMappingTestDomainErrors.GetType (
          "Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping.TestDomain.Errors.MixinAddingBidirectionalRelationTwice", true, false);
    }
  }
}
