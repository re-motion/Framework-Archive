...
namespace Remotion.Data.DomainObjects.UnitTests.Core.Configuration.Mapping
{
  ...
  public class RelationReflectorWithMixinsTest : StandardMappingTest
  {
    ...
    public void GetMetadata_Mixed_BidirectionalOneToOne ()
    {
      ...
      Assert.AreSame (_relatedClassDefinition, oppositeEndPointDefinition.ClassDefinition);
      Assert.AreEqual (
          "Remotion.Data.DomainObjects.UnitTests.Core.MixedDomains.SampleTypes.RelationTargetForPersistentMixin.RelationProperty1",
    ...
    public void GetMetadata_Mixed_BidirectionalOneToMany ()
    {
      ...
      Assert.AreSame (_relatedClassDefinition, oppositeEndPointDefinition.ClassDefinition);
      Assert.AreEqual (
          "Remotion.Data.DomainObjects.UnitTests.Core.MixedDomains.SampleTypes.RelationTargetForPersistentMixin.RelationProperty4",
          oppositeEndPointDefinition.PropertyName);
