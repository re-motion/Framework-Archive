...
namespace Remotion.Data.DomainObjects.UnitTests.Core.DomainObjects
{
  ...
  public class ReplaceInOneToManyRelationTest : ClientTransactionBaseTest
  {
      ...
      ChangeState[] expectedChangeStates = new ChangeState[]
    {
      ...
      new RelationChangeState (_oldOrder, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "8. Changed event of old order from old customer to null"),
      new RelationChangeState (_newOrder, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "9. Changed event of new order from null to new customer"),
      ...
      new RelationChangeState (_customer, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", null, null, "12. Changed event of customer"),
      ...
      new RelationChangeState (_oldCustomerOfNewOrder, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", null, null, "14. Changed event of oldCustomerOfNewOrder")
    };
      ...
      ChangeState[] expectedChangeStates = new ChangeState[]
    {
      ...
      new RelationChangeState (_oldOrder, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "6. Changed event of old order from old customer to null"),
      new RelationChangeState (newOrder, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "7. Changed event of new order from null to new customer"),
      ...
      Assert.AreEqual (StateType.New, newOrder.State);
			Assert.AreEqual (_customer.ID, newOrder.InternalDataContainer.GetValue ("Remotion.Data.DomainObjects.UnitTests.TestDomain.Order.Customer"));
      ...
      ChangeState[] expectedStates = new ChangeState[]
    {
      ...
      new RelationChangeState (_oldOrder, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "6. Changed event of old order from new customer to null"),
      new RelationChangeState (newOrder, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Order.Customer", null, null, "7. Changed event of new order from old to new customer"),
      ...
      new RelationChangeState (_customer, "Remotion.Data.DomainObjects.UnitTests.TestDomain.Customer.Orders", null, null, "10. Changed event of new customer from old order to new order"),
    };
