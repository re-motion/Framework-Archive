...
namespace Remotion.Data.DomainObjects.UnitTests.Core.Interception
{
  ...
  public class InterceptedDomainObjectFactoryTest : ClientTransactionBaseTest
  {
    ...
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = "Cannot instantiate type "
       + "Remotion.Data.DomainObjects.UnitTests.Core.Interception.SampleTypes.NonInstantiableAbstractClassWithProps as its "
    ...
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = "The domain object's type "
        + "Remotion.Data.DomainObjects.UnitTests.Core.Interception.SampleTypes.DOWithConstructors was not "
