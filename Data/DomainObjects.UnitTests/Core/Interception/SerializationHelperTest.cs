...
namespace Remotion.Data.DomainObjects.UnitTests.Core.Interception
{
  ...
  public class SerializationHelperTest : ClientTransactionBaseTest
  {
    ...
    [ExpectedException (typeof (SerializationException), ExpectedMessage = "The deserialization constructor on type "
        + "Remotion.Data.DomainObjects.UnitTests.Core.Interception.SerializationHelperTest+SerializableClassImplementingISerializableNotCallingBaseCtor "
    ...
    [ExpectedException (typeof (SerializationException), ExpectedMessage = "The GetObjectData method on type "
        + "Remotion.Data.DomainObjects.UnitTests.Core.Interception.SerializationHelperTest+SerializableClassImplementingISerializableNotCallingBaseGetObjectData"
