...
namespace Remotion.Data.DomainObjects.UnitTests.Core.Interception
{
  ...
  public class InterceptedPropertyIntegrationTest : ClientTransactionBaseTest
  {
    ...
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = "Cannot instantiate type "
                                                                      + "Remotion.Data.DomainObjects.UnitTests.Core.Interception.SampleTypes.NonInstantiableAbstractClassWithProps "
    ...
    [Test]
    [ExpectedException(typeof (ArgumentException), ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests."
                                                                    + "Core.Interception.SampleTypes.NonInstantiableClassWithAutomaticRelatedCollectionSetter, automatic "
                                                                     + "properties for related object collections cannot have setters: property 'RelatedObjects', property id 'Remotion.Data.DomainObjects."
                                                                      + "UnitTests.Core.Interception.SampleTypes.NonInstantiableClassWithAutomaticRelatedCollectionSetter."
                                                                     + "RelatedObjects'.",
        MatchType = MessageMatch.Contains)]
    ...
    [Test]
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = "Cannot instantiate type Remotion.Data.DomainObjects.UnitTests.Core.Interception."
    ...
    [Test]
    [ExpectedException (typeof (MissingMethodException), ExpectedMessage = "Type Remotion.Data.DomainObjects.UnitTests.Core.Interception."
