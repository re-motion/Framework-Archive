  ...
  public class ConcreteTableInheritanceRelationLoaderTest : SqlProviderBaseTest
  {
    ...
    public override void SetUp ()
    {
      ...
      _loader = new ConcreteTableInheritanceRelationLoader (
          Provider, _domainBaseClass, _domainBaseClass.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.DomainBase.Client"), DomainObjectIDs.Client);
    }
    ...
    public void LoadDataContainerWithInvalidClassID ()
    {
      ConcreteTableInheritanceRelationLoader loader = new ConcreteTableInheritanceRelationLoader (
          Provider, _domainBaseClass, _domainBaseClass.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.DomainBase.Client"), 
    ...
    public void LoadDataContainersWithNoConcreteEntity ()
    {
      ...
      ConcreteTableInheritanceRelationLoader loader = new ConcreteTableInheritanceRelationLoader (
          ...
          abstractClassWithoutDerivationsClass.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.AbstractClassWithoutDerivations.DomainBase"), 
