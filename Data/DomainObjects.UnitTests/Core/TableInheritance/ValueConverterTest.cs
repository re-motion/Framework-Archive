...
namespace Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance
{
  ...
  public class ValueConverterTest : SqlProviderBaseTest
  {
    ...
    public void GetObjectIDValue ()
    {
      ...
      PropertyDefinition clientProperty = personClass.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.DomainBase.Client");
    ...
    public void GetValueWithMissingRelationClassIDColumn ()
    {
      ...
      using (IDbCommand command = builder.Create ())
      {
        using (IDataReader reader = command.ExecuteReader ())
        {
          ...
          _converter.GetValue (
              classDefinition, 
              classDefinition.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.BaseClassWithInvalidRelationClassIDColumns.DomainBase"),
              reader);
        }
      }
    }
    ...
    public void GetValueWithInvalidRelationClassIDColumn ()
    {
      ...
      using (IDbCommand command = builder.Create ())
      {
        using (IDataReader reader = command.ExecuteReader ())
        {
          ...
          _converter.GetValue (
              classDefinition, 
              classDefinition.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.BaseClassWithInvalidRelationClassIDColumns.Client"),
              reader);
        }
      }
    }
    ...
    public void GetValueWithInvalidRelationClassIDColumnValue ()
    {
      ...
      using (IDbCommand command = builder.Create ())
      {
        using (IDataReader reader = command.ExecuteReader ())
        {
          ...
          _converter.GetValue (
              classDefinition, 
              classDefinition.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.BaseClassWithInvalidRelationClassIDColumns.DomainBaseWithInvalidClassIDValue"),
              reader);
        }
      }
    }
    ...
    public void GetValueWithInvalidRelationClassIDColumnNullValue ()
    {
      ...
      using (IDbCommand command = builder.Create ())
      {
        using (IDataReader reader = command.ExecuteReader ())
        {
          ...
          _converter.GetValue (
              classDefinition, 
              classDefinition.GetMandatoryPropertyDefinition ("Remotion.Data.DomainObjects.UnitTests.Core.TableInheritance.TestDomain.BaseClassWithInvalidRelationClassIDColumns.DomainBaseWithInvalidClassIDNullValue"),
              reader);
        }
      }
    }
