...
namespace Remotion.Data.DomainObjects.UnitTests.Core.ObjectIDs
{
  [TestFixture]
  public class ObjectIDTest : StandardMappingTest
  {
    ...
    [ExpectedException (typeof (ArgumentException), ExpectedMessage = 
        "The ClassID 'Order' and the ClassType 'Remotion.Data.DomainObjects.UnitTests.Core.ObjectIDs.ObjectIDTest+InvalidDomainObject'"
