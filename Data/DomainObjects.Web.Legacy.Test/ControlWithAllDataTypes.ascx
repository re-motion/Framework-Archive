<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ControlWithAllDataTypes.ascx.cs" Inherits="Remotion.Data.DomainObjects.Web.Legacy.Test.ControlWithAllDataTypes" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>


<remotion:formgridmanager id="FormGridManager" runat="server" visible="true"></remotion:formgridmanager>
<remotion:domainobjectdatasourcecontrol id="CurrentObject" runat="server" TypeName="Remotion.Data.DomainObjects.Web.Legacy.Test.Domain.ClassWithAllDataTypes, Remotion.Data.DomainObjects.Web.Legacy.Test"></remotion:domainobjectdatasourcecontrol>
