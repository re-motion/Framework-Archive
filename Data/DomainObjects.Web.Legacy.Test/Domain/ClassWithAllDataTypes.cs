...
public class ClassWithAllDataTypes : BindableDomainObject
{
  ...
  public string[] StringArray
  {
    get
    {
      return ((string) DataContainer.GetValue ("DelimitedStringArrayProperty")).Split (';');
    }
    set
    {
      if (value == null)
  ...
  public string[] NullStringArray
  {
    get
    {
      string delimitedNullStringArray = (string) DataContainer.GetValue ("DelimitedNullStringArrayProperty");
