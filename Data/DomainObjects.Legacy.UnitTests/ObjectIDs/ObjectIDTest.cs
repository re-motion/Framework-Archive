...
namespace Remotion.Data.DomainObjects.Legacy.UnitTests.ObjectIDs
{
  ...
  public class ObjectIDTest : StandardMappingTest
  {
    ...
    {
      XmlBasedClassDefinition unknownDefinition = new XmlBasedClassDefinition ("UnknownClass", "UnknownTable", "TestDomain", typeof (Order));
      Guid value = new Guid ("{5682F032-2F0B-494b-A31C-C97F02B89C36}");
    ...
    {
      XmlBasedClassDefinition unknownDefinition = new XmlBasedClassDefinition ("Order", "Order", "TestDomain", typeof (InvalidDomainObject));
      Guid value = new Guid ("{5682F032-2F0B-494b-A31C-C97F02B89C36}");
    ...
    {
      XmlBasedClassDefinition invalidDefinition = new XmlBasedClassDefinition ("Order", "Order", "TestDomain", typeof (Customer));
    ...
    {
      XmlBasedClassDefinition invalidDefinition = new XmlBasedClassDefinition ("Order", "Order", "TestDomain", typeof (Order));
      ObjectID id = new ObjectID (invalidDefinition, Guid.NewGuid ());
    }
