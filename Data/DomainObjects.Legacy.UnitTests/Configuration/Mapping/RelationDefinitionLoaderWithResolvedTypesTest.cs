...
namespace Remotion.Data.DomainObjects.Legacy.UnitTests.Configuration.Mapping
{
  ...
  [TestFixture]
  public class RelationDefinitionLoaderWithResolvedTypesTest : StandardMappingTest
  {
    // types
    ...
    public override void SetUp ()
    {
      ...
      mappingDocument.Load ("DataDomainObjectsLegacy_MappingWithResolvedTypes.xml");
