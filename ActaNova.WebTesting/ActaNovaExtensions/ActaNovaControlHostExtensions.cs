...
namespace ActaNova.WebTesting.ActaNovaExtensions
{
  public static class ActaNovaControlHostExtensions
  {
    ...
    public static FluentControlSelector<ActaNovaTreeViewAutoCompleteReferenceValueSelector, ActaNovaTreeViewAutoCompleteReferenceValueControlObject>
        GetTreeViewAutoComplete (this IControlHost host)
    {
      return new FluentControlSelector<ActaNovaTreeViewAutoCompleteReferenceValueSelector, ActaNovaTreeViewAutoCompleteReferenceValueControlObject> (
          host,
          new ActaNovaTreeViewAutoCompleteReferenceValueSelector());
    }

    public static ActaNovaTreeViewAutoCompleteReferenceValueControlObject GetTreeViewAutoComplete (
        this IControlHost host,
        string domainProperty,
        string domainClass = null)
    {
