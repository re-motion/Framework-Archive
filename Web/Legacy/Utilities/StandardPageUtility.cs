...
public class StandardPageUtility
{
  ...
  {
    return RemoveHttps (page, StandardPageUtility.GetPhysicalPageUrl (page, relativeUrl));
  }
  ...
  {    
    string referrerUrl = StandardPageUtility.GetPhysicalPageUrl (sourcePage);
  ...
  {    
    ...
    string url = StandardPageUtility.GetPhysicalPageUrl (sourcePage, relAppPath);
